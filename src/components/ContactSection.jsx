      ...
      <div className="max-w-2xl mx-auto space-y-4">
        ...
        <div className="relative overflow-hidden bg-surface border border-border rounded-2xl p-5 flex items-center gap-4">
          ...
          <div className="relative w-14 h-14 rounded-2xl bg-gradient-to-br from-accent/20 to-teal-500/20 border border-accent/30 flex items-center justify-center shrink-0">
            <span className="text-accent font-bold text-lg tracking-tight">ND</span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-accent/10 border border-accent/20 flex items-center justify-center text-xl shrink-0 group-hover:bg-accent/15 group-hover:border-accent/40 transition-all duration-200">
                ✉️
              </div>
          ...
          >
            ...
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-xl shrink-0 group-hover:bg-blue-500/15 group-hover:border-blue-500/40 transition-all duration-200">
                💬
              </div>
              <div>
