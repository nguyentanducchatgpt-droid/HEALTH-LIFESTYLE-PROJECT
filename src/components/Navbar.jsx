    ...
    <nav className="sticky top-0 z-50 glass border-b border-border/60">
      <div className="max-w-6xl mx-auto px-4 md:px-8 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-1">
          ...
          <Link
            to="/"
            className={`relative px-2 py-1.5 text-sm font-medium rounded-lg transition-all duration-200 ${
          ...
          >
            <Link
              ...
              className={`relative flex items-center gap-1 px-2 py-1.5 text-sm font-medium rounded-lg transition-all duration-200 ${
