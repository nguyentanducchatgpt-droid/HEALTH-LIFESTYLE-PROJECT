      ...
      >
        ...
        <div className="p-3">
          ...
          <div className="flex items-center justify-between mb-2">
            <div
              className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-black border ${sc.border} ${sc.bg} ${sc.text}`}
            >
              {step.n}
            </div>
          ...
          {/* Title */}
          <p className={`font-black text-sm mb-1 transition-colors ${isActive ? sc.text : 'text-text group-hover:text-text'}`}>
            {step.title}
          </p>
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-center gap-3 mb-5">
        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-black border ${sc.border} ${sc.text}`}>
          {step.n}
        </div>
        <div>
          <h3 className={`font-black text-base ${sc.text}`}>{step.title}</h3>
          <p className="text-[10px] text-muted">{step.period}</p>
        </div>
        <span className={`ml-auto text-xs font-bold px-2.5 py-1 rounded-full ${sc.bg} ${sc.text} border ${sc.border}`}>
          {step.badge}
        </span>
      </div>
      ...
      <div className="mb-4">
        ...
        <p className="text-sm text-text leading-relaxed">{step.target}</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="space-y-3">
          <div>
            ...
            <p className="text-xs text-text/80 leading-relaxed">{step.passWhen}</p>
          </div>
  ...
  return (
    <section className="mb-16">
      ...
      <div className="mb-6">
        ...
        <p className="text-muted text-sm">Chọn mục tiêu — xem lộ trình từng bước — đánh dấu bước bạn đang ở</p>
      </div>
      ...
      >
        ...
        <div>
          <p className={`font-black text-sm ${gc.text}`}>{goalData.name}</p>
              ...
              <div key={step.n} className="relative">
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <p className={`font-black text-sm mb-0.5 ${isActive ? sc.text : 'text-text'}`}>{step.title}</p>
