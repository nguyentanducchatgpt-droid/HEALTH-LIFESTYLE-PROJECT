  ...
  },
  {
    ...
    blocks: [
      ...
      { name:'Tim Mạch', mins:10, icon:'🚶', color:'blue',
        ...
        exercises:['Đi bộ nhanh 10 phút','Hoặc: Leo cầu thang','Hoặc: Đạp xe tại chỗ'] },
      { name:'Giãn Cơ',  mins:5,  icon:'🧘', color:'teal',
        img:'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=500&q=70',
  ...
  },
  {
    ...
    blocks: [
      ...
      { name:'Tim Mạch', mins:15, icon:'🚶', color:'blue',
        ...
        exercises:['Đi bộ nhanh 15 phút','Hoặc: Đạp xe Zone 2','Nhịp tim: 50–65% HRmax'] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { name:'Tim Mạch', mins:20, icon:'🚶', color:'blue',
        ...
        exercises:['Đi bộ nhanh 20 phút','Hoặc: LISS Zone 2','Hoặc: Đạp xe 20 phút'] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { name:'Tim Mạch', mins:30, icon:'🚶', color:'blue',
        ...
        exercises:['Zone 2 cardio 30 phút','Nhịp tim: 55–70% HRmax','Uống nước mỗi 10 phút'] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { name:'Tim Mạch', mins:35, icon:'🚶', color:'blue',
        ...
        exercises:['Zone 2 cardio 35 phút','Đạp xe hoặc đi bộ nhanh','Nhịp tim: 60–70% HRmax'] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { name:'Tim Mạch', mins:40, icon:'🚶', color:'blue',
        ...
        exercises:['Zone 2 LISS 25 phút','Tempo intervals 10 phút','Active recovery walk 5 phút'] },
      { name:'Giãn Cơ',  mins:25, icon:'🧘', color:'teal',
        img:'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=500&q=70',
  ...
  },
  {
    ...
    blocks: [
      ...
      { name:'Tim Mạch', mins:45, icon:'🚶', color:'blue',
        ...
        exercises:['Zone 2 base 30 phút','Zone 3 tempo intervals 10 phút','Zone 1 cool-down walk 5 phút'] },
