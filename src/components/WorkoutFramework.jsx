...
const FRAMEWORKS = [
  {
    ...
    blocks: [
      ...
      { name:'Sức Mạnh', mins:12, icon:'💪', color:'green',
        ...
        exercises:['Squat 2 × 10','Hít đất 2 × 8','Plank 2 × 20 giây','Cầu mông 2 × 12'] },
  ...
  },
  {
    ...
    blocks: [
      { name:'Khởi Động', mins:5,  icon:'🔥', color:'orange',
        ...
        exercises:['Thở cơ hoành × 5','Đi bộ tại chỗ 60 giây','Xoay vai × 10','Gập hông × 8','Squat nhẹ × 8'] },
      { name:'Sức Mạnh', mins:20, icon:'💪', color:'green',
        img:'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=500&q=70',
        desc:'Xây dựng cơ bắp nền tảng — nghỉ 60 giây',
        exercises:['Squat 3 × 10','Hít đất 3 × 10','Kéo dây 3 × 12','Lunges 2 × 10/bên','Plank 3 × 30 giây'] },
  ...
  },
  {
    ...
    blocks: [
      { name:'Khởi Động', mins:8,  icon:'🔥', color:'orange',
        ...
        exercises:['Thở cơ hoành × 8','Đi bộ & nâng gối 90 giây','Xoay khớp đầy đủ','Squat nhẹ × 10','Gập hông × 10','Xoay vòng hông × 10'] },
      { name:'Sức Mạnh', mins:25, icon:'💪', color:'green',
        img:'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=500&q=70',
        desc:'Kích thích tất cả nhóm cơ lớn — nghỉ 75 giây',
        exercises:['Squat 3 × 12','Romanian DL 3 × 10','Hít đất nâng cao 3 × 12','Kéo dây 3 × 12','Lunges 3 × 10/bên','Plank 3 × 40 giây','Superman 2 × 12'] },
  ...
  },
  {
    ...
    blocks: [
      { name:'Khởi Động', mins:8,  icon:'🔥', color:'orange',
        ...
        exercises:['Thở cơ hoành × 8','Đi bộ 90 giây','Vận động linh hoạt toàn thân 3 phút','Squat & gập hông nhẹ × 10'] },
      { name:'Sức Mạnh', mins:35, icon:'💪', color:'green',
        img:'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=500&q=70',
        desc:'Khối lượng đủ lớn để tạo đà tăng trưởng',
        exercises:['Squat 4 × 10','Romanian DL 3 × 12','Hít đất 4 × 12','Kéo dây 4 × 12','Lunges 3 × 10/bên','Plank 3 × 45 giây','Superman 3 × 12','Xoay thân 2 × 15'] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { name:'Sức Mạnh', mins:50, icon:'💪', color:'green',
        ...
        exercises:['Squat 4 × 12','Romanian DL 4 × 10','Hít đất nâng cao 4 × 15','Kéo dây 4 × 12','Lunges 4 × 10/bên','Đẩy vai 3 × 10','Plank 4 × 50 giây','Superman 3 × 15','Nâng gối treo xà 3 × 12'] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { name:'Sức Mạnh', mins:60, icon:'💪', color:'green',
        ...
        exercises:['Squat 5 × 12','Romanian DL 4 × 10','Hít đất nâng cao 5 × 15','Kéo dây 5 × 12','Lunges 4 × 12/bên','Đẩy vai 4 × 10','Plank 5 × 60 giây','Superman 3 × 15','Nâng gối treo xà 4 × 12','Crunch đạp xe 3 × 20'] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { name:'Sức Mạnh', mins:70, icon:'💪', color:'green',
        ...
        exercises:['Biến thể Squat 5 × 12','Biến thể Deadlift 5 × 10','Hít đất nâng cao 5 × 15','Kéo dây 5 × 12','Lunges nâng cao 4 × 12/bên','Đẩy vai 4 × 10','Biến thể Plank 5 × 60 giây','Cơ lõi chống xoay 4 × 12','Cô lập cơ mông & đùi sau 4 × 12','Bài bổ trợ kết thúc 15 phút'] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { name:'Sức Mạnh', mins:80, icon:'💪', color:'green',
        ...
        exercises:['Biến thể Squat 5 × 12–15','Biến thể gập hông (Hinge) 5 × 10','Biến thể đẩy 5 × 15','Biến thể kéo 5 × 12','Vòng Lunges 5 × 12/bên','Cơ lõi toàn diện 6 hiệp','Bài tập sức mạnh bùng nổ 15 phút','Bài tập bổ trợ 20 phút'] },
