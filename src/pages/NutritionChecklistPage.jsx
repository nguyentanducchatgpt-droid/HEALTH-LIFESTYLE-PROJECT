...
function ScoreGauge({ score }) {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="mt-2 text-sm font-bold" style={{ color: tier.color }}>{tier.label}</div>
    </div>
  );
}
...
export default function NutritionChecklistPage() {
  ...
  return (
    <div className="px-4 md:px-6 max-w-4xl mx-auto pt-28 md:pt-32 pb-24">
      ...
      {/* Breadcrumb */}
      <Link to="/pillar/b" className="inline-flex items-center gap-1.5 text-xs text-muted hover:text-emerald-400 transition-colors mb-8">
        ← Dinh Dưỡng
      </Link>
      ...
      <div className="flex items-start gap-6 mb-10 relative">
        ...
        <div className="w-20 h-20 rounded-3xl text-5xl flex items-center justify-center bg-surface border border-emerald-500/20 shrink-0 cl-float">
          ✅
        </div>
        <div>
          <h1 className="text-4xl md:text-5xl font-bold text-text leading-tight cl-fade-up">
            Checklist Nutrition <span className="text-emerald-400">Hằng Ngày</span>
          </h1>
          <span className="inline-block text-xs font-bold uppercase tracking-widest text-emerald-400 mt-3 mb-4 px-3 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded-full">
      ...
      <div className="cl-orbit-ring rounded-3xl p-[1.5px] mb-12">
        <div className="relative rounded-3xl overflow-hidden h-52 md:h-72">
          ...
          <span className="absolute bottom-4 left-6 text-emerald-400 text-xs font-bold uppercase tracking-widest bg-bg/60 px-3 py-1 rounded-full border border-emerald-500/20">
            Checklist · Hằng Ngày
          </span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {HERO_STATS.map((s, i) => (
            <div key={i} className="group/stat relative flex flex-col items-center py-5 px-3 rounded-2xl border border-emerald-500/15 bg-emerald-500/5">
              ...
              <span className="text-3xl font-black text-emerald-400">{s.n}</span>
      ...
      <RevealBlock className="mb-10">
        <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-5">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-emerald-400 text-xs font-bold uppercase tracking-widest">Cá Nhân Hóa Từ B0</span>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
            {[
              ...
              <div key={i} className="rounded-xl border border-emerald-500/10 bg-bg/40 p-3 text-center">
                <div className="text-emerald-400 font-black text-lg">{item.value}</div>
      ...
      <RevealBlock className="mb-10">
        <div className="mb-4">
          <p className="text-xs font-bold text-muted uppercase tracking-widest mb-3">Hôm Nay Là Ngày Gì?</p>
        ...
        {activeDayType && (
          <div className="rounded-2xl border p-5 transition-all duration-300" style={{ borderColor: `${activeDayType.color}30`, background: `${activeDayType.color}08` }}>
            <p className="text-xs font-bold mb-3" style={{ color: activeDayType.color }}>Gợi Ý Hôm Nay — {activeDayType.label} {activeDayType.emoji}</p>
      ...
      <RevealBlock className="mb-10">
        <div className="rounded-3xl border border-emerald-500/20 bg-emerald-500/5 p-6 md:p-8">
          <div className="flex items-center justify-between mb-6">
            <div>
              <p className="text-xs font-bold text-emerald-400 uppercase tracking-widest">Điểm Hôm Nay</p>
                ...
                return (
                  ...
                  >
                    <div className="w-5 h-5 rounded-md border-2 flex items-center justify-center shrink-0 transition-all duration-200"
                      ...
                      {checked && <span className="text-bg text-xs font-black cl-check-bounce">✓</span>}
                    </div>
      ...
      <RevealBlock className="mb-10">
        <p className="text-xs font-bold text-muted uppercase tracking-widest mb-4">Checklist Chi Tiết Theo Buổi</p>
        {/* Tabs */}
        ...
        <div className="rounded-2xl border border-white/8 bg-white/[0.018] p-5">
          ...
          {activeTab === 'A' && (
            <div className="space-y-5">
              <p className="text-xs font-bold text-emerald-400">Checklist Buổi Sáng</p>
          ...
          {activeTab === 'B' && (
            <div className="space-y-5">
              <p className="text-xs font-bold text-emerald-400">Mỗi Bữa Chính</p>
              {/* Plate diagram */}
                ...
                <div className="space-y-1.5">
                  {DAY_TYPES.map((dt) => (
                    <div key={dt.id} className="flex items-center gap-3 px-3 py-2 rounded-lg border transition-all duration-200"
                      ...
                      <span className="text-base w-6 shrink-0">{dt.emoji}</span>
          ...
          {activeTab === 'C' && (
            <div className="space-y-5">
              <p className="text-xs font-bold text-emerald-400">Trước &amp; Sau Buổi Tập</p>
              <div>
          ...
          {activeTab === 'D' && (
            <div className="space-y-5">
              <p className="text-xs font-bold text-emerald-400">Nước &amp; Điện Giải</p>
              <div>
                ...
                <div className="flex gap-2 flex-wrap">
                  {Array.from({ length: 8 }, (_, i) => i + 1).map(n => (
                    <button key={n} onClick={() => setWater(waterCount === n ? n - 1 : n)}
                      className="w-10 h-10 rounded-xl border text-base transition-all duration-200"
                      style={{
          ...
          {activeTab === 'E' && (
            <div className="space-y-5">
              <p className="text-xs font-bold text-emerald-400">Ăn Vặt &amp; Đồ Ngọt</p>
              <div>
                  ...
                  {[
                    ...
                    <div key={i}>
                      <button onClick={() => setSnackOpen(snackOpen === i ? null : i)}
                        ...
                        <span className="text-muted text-xs">{snackOpen === i ? '−' : '+'}</span>
                      </button>
                      {snackOpen === i && (
          ...
          {activeTab === 'F' && (
            <div className="space-y-5">
              <p className="text-xs font-bold text-emerald-400">Ăn Ngoài Thông Minh</p>
              <div className="rounded-xl border border-emerald-500/15 bg-emerald-500/5 p-4">
          ...
          {activeTab === 'G' && (
            <div className="space-y-5">
              <p className="text-xs font-bold text-emerald-400">Review &amp; Chuẩn Bị Ngày Mai</p>
              <div>
              ...
              <div className="rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4 text-center">
                ...
                <p className="text-3xl font-black text-emerald-400">{score}<span className="text-lg text-muted">/100</span></p>
      ...
      <RevealBlock className="mb-10">
        <p className="text-xs font-bold text-muted uppercase tracking-widest mb-4">Chọn Cấp Độ Của Bạn</p>
        <div className="grid md:grid-cols-3 gap-4">
          {LEVELS.map(lv => (
            <div key={lv.id}>
              ...
              >
                <div className="text-2xl mb-2">{lv.emoji}</div>
      ...
      <RevealBlock className="mb-10">
        <div className="rounded-2xl border border-white/10 p-5 bg-white/[0.018]">
          <p className="text-xs font-bold text-muted uppercase tracking-widest mb-4">Template Ghi Log Hằng Ngày</p>
      ...
      <RevealBlock className="mb-10">
        <div className="rounded-2xl border border-emerald-500/15 p-5">
          <div className="flex items-center justify-between mb-4">
            <p className="text-xs font-bold text-muted uppercase tracking-widest">Checklist Tuần Này</p>
