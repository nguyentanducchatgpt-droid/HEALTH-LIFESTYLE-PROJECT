    ...
    <div className="min-h-screen pb-24" style={{ background: '#0a0a0a', color: '#e5e7eb' }}>
      <div className="px-4 md:px-6 max-w-4xl mx-auto pt-28 md:pt-32">
        ...
        <div className="flex items-start gap-6 mb-10 relative">
          ...
          {/* Icon */}
          <div
            className="w-20 h-20 rounded-3xl text-5xl flex items-center justify-center shrink-0 border"
        ...
        <div className="grid grid-cols-4 gap-3 mb-12">
          {[
            ...
            >
              <span className="text-xl md:text-2xl font-bold" style={{ color: LIME }}>{b.value}</span>
              <span className="text-xs font-semibold text-gray-300 mt-0.5">{b.label}</span>
        ...
        <RevealBlock className="mb-14">
          <h2 className="text-2xl font-bold mb-2" style={{ color: '#f1f5f9' }}>Tại Sao Phải Chia Bữa?</h2>
          <p className="text-sm text-gray-500 mb-6">5 mục tiêu của hệ thống chia bữa khoa học</p>
            ...
            {[
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="w-5 h-5 rounded-full text-xs font-bold flex items-center justify-center flex-shrink-0" style={{ background: LIME, color: '#0a0a0a' }}>{g.n}</span>
                </div>
                <p className="text-sm font-semibold text-gray-200">{g.text}</p>
          ...
          <div className="mt-6 p-4 rounded-xl border-l-4 flex flex-col gap-1.5" style={{ background: 'rgba(132,204,22,0.06)', borderColor: LIME }}>
            <p className="text-sm font-bold" style={{ color: LIME }}>Nguyên tắc cốt lõi</p>
            <p className="text-sm text-gray-300">Tính tổng ngày trước → chia nhỏ sau</p>
            <div className="flex flex-wrap gap-4 mt-1">
              <code className="text-xs px-2 py-1 rounded" style={{ background: 'rgba(132,204,22,0.10)', color: LIME }}>Kcal bữa = Tổng kcal ngày × tỷ lệ bữa</code>
              <code className="text-xs px-2 py-1 rounded" style={{ background: 'rgba(132,204,22,0.10)', color: LIME }}>Protein bữa = Tổng protein × tỷ lệ</code>
            </div>
          </div>
        </RevealBlock>
        ...
        ═══════════════════════════════════════════════════════════════════ */}
        <RevealBlock className="mb-14">
          <h2 className="text-2xl font-bold mb-2" style={{ color: '#f1f5f9' }}>Tính Toán Cá Nhân Của Bạn</h2>
          ...
          <div className="flex flex-wrap gap-2 mb-5">
            {MEAL_MODELS.map((m, i) => (
              ...
              >
                ...
                <span>{m.name}</span>
                {m.tag && (
                  <span className="text-xs px-1.5 py-0.5 rounded-full font-bold" style={{ background: `${m.color}30`, color: m.color }}>
                    {m.tag}
                  </span>
                )}
              </button>
          ...
          <div className="p-5 rounded-2xl border" style={{ background: 'rgba(255,255,255,0.03)', borderColor: 'rgba(255,255,255,0.07)' }}>
            <p className="text-sm font-semibold text-gray-300 mb-4">Phân bổ từng bữa — {model.name}</p>
              ...
              {mealBreakdown.map((m, i) => (
                <div key={i}>
                  ...
                  <div className="flex justify-between mt-0.5">
                    <span className="text-xs text-gray-600">{m.pct}% tổng ngày</span>
                  </div>
                </div>
              ))}
            </div>
            <div className="mt-4 pt-4 border-t flex items-center gap-2" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
              <span className="text-xs text-gray-400">Protein/bữa chính ≈</span>
              ...
              <span className="text-xs text-gray-500">• ISSN khuyến nghị 20–40g/bữa</span>
            </div>
          </div>
        </RevealBlock>
        ...
        ═══════════════════════════════════════════════════════════════════ */}
        <RevealBlock className="mb-14">
          <h2 className="text-2xl font-bold mb-2" style={{ color: '#f1f5f9' }}>4 Mô Hình Bữa Ăn</h2>
          <p className="text-sm text-gray-500 mb-6">Chọn mô hình phù hợp với lịch sống của bạn</p>
          ...
          <div className="grid md:grid-cols-4 grid-cols-2 gap-3 mb-6">
            {MEAL_MODELS.map((m, i) => (
              ...
              >
                ...
                <p className="text-sm font-bold mb-1" style={{ color: selectedModel === i ? m.color : '#e5e7eb' }}>{m.name}</p>
                <p className="text-xs text-gray-500 leading-snug">{m.best}</p>
                {m.tag && (
                  <span className="mt-2 inline-block text-xs px-2 py-0.5 rounded-full font-bold" style={{ background: `${m.color}25`, color: m.color }}>
                    {m.tag}
                  </span>
                )}
              </button>
          ...
          {/* Animated bar chart */}
          <div className="p-5 rounded-2xl border" style={{ background: 'rgba(255,255,255,0.03)', borderColor: 'rgba(255,255,255,0.07)' }}>
            <p className="text-sm font-semibold text-gray-400 mb-4">Phân bổ % calo theo bữa</p>
            <div className="flex items-end gap-2 h-32">
              {model.meals.map((m, i) => (
                <div key={i} className="flex-1 flex flex-col items-center justify-end h-full gap-1">
                  <span className="text-xs font-bold" style={{ color: model.color }}>{m.pct}%</span>
                  <div
        ...
        ═══════════════════════════════════════════════════════════════════ */}
        <RevealBlock className="mb-14">
          <h2 className="text-2xl font-bold mb-2" style={{ color: '#f1f5f9' }}>Công Thức Đĩa Ăn</h2>
          <p className="text-sm text-gray-500 mb-6">Nhấn từng phần để xem chi tiết</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            <div className="flex flex-col items-center">
              ...
              {activeSliceData && (
                ...
                >
                  <p className="text-sm" style={{ color: activeSliceData.color }}>{activeSliceData.detail}</p>
                </div>
              )}
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="p-4 rounded-xl border" style={{ background: 'rgba(132,204,22,0.05)', borderColor: 'rgba(132,204,22,0.15)' }}>
                <p className="text-xs text-gray-500 mb-2 uppercase tracking-widest">Công Thức</p>
              ...
              {/* Hand measures */}
              <p className="text-xs text-gray-500 uppercase tracking-widest">Đo bằng tay</p>
              <div className="grid grid-cols-2 gap-3">
                {HAND_MEASURES.map((h) => (
                  ...
                  >
                    ...
                    <p className="text-xs font-bold" style={{ color: h.color }}>{h.label}</p>
                    <p className="text-xs text-gray-400 mt-0.5">{h.detail}</p>
                    <p className="text-xs text-gray-600 mt-0.5">{h.example}</p>
                  </div>
                ))}
              </div>

              {/* Quote */}
              <blockquote className="p-4 rounded-xl border-l-4 italic text-sm text-gray-400" style={{ borderColor: LIME, background: 'rgba(132,204,22,0.04)' }}>
        ...
        ═══════════════════════════════════════════════════════════════════ */}
        <RevealBlock className="mb-14">
          <h2 className="text-2xl font-bold mb-2" style={{ color: '#f1f5f9' }}>Carb Cycling Theo Ngày Tập</h2>
          <p className="text-sm text-gray-500 mb-6">
                  ...
                  <div className="flex items-center justify-between mb-2 flex-wrap gap-2">
                    ...
                    <div className="flex gap-4 text-right">
                      <div>
                        ...
                        <p className="text-base font-bold" style={{ color: d.color }}>{carbVal}g</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Kcal</p>
                        <p className="text-base font-bold text-gray-300">{kcalVal}</p>
                      </div>
                      <div>
                        <p className="text-xs text-gray-500">Hệ số</p>
                        <p className="text-base font-bold text-gray-300">×{d.carbMult}</p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="mt-4 p-3 rounded-lg border text-xs text-gray-500" style={{ borderColor: 'rgba(255,255,255,0.06)', background: 'rgba(255,255,255,0.02)' }}>
        ...
        ═══════════════════════════════════════════════════════════════════ */}
        <RevealBlock className="mb-14">
          <h2 className="text-2xl font-bold mb-2" style={{ color: '#f1f5f9' }}>Lịch Ăn Theo Giờ Tập</h2>
          <p className="text-sm text-gray-500 mb-6">Điều chỉnh timing bữa ăn cho từng ca tập</p>
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {TRAINING_TIMES.map((t) => (
              ...
              >
                ...
                {t.tag && (
                  <span className="text-xs px-1.5 py-0.5 rounded-full font-bold" style={{ background: `${t.color}25`, color: t.color }}>
                    {t.tag}
                  </span>
                )}
              </button>
                  ...
                  <div key={i} className="flex gap-4 group">
                    ...
                    >
                      <div className="flex items-start justify-between gap-2 flex-wrap">
                        <p className={`text-sm font-semibold ${step.type === 'workout' ? 'text-white' : 'text-gray-300'}`}>
                          {step.type === 'workout' && <span className="mr-1">🏋️</span>}
                          {step.meal}
                        </p>
                        <span className="text-xs font-mono text-gray-500 flex-shrink-0">{step.time}</span>
                      </div>
        ...
        ═══════════════════════════════════════════════════════════════════ */}
        <RevealBlock className="mb-14">
          <h2 className="text-2xl font-bold mb-2" style={{ color: '#f1f5f9' }}>Quy Tắc Theo Mục Tiêu</h2>
          <p className="text-sm text-gray-500 mb-6">Nhấn để mở rộng — xem quy tắc cụ thể cho từng goal</p>
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">{g.model} · {g.detail}</p>
                      </div>
                    </div>
                    <span
                      ...
                      <ul className="space-y-2">
                        {g.rules.map((r, i) => (
                          <li key={i} className="flex items-start gap-2 text-sm text-gray-300">
                            <span className="mt-1 w-4 h-4 rounded-full text-xs font-bold flex items-center justify-center flex-shrink-0"
          ...
          <div className="mt-6 p-5 rounded-2xl border-l-4" style={{ background: 'rgba(132,204,22,0.06)', borderColor: LIME }}>
            ...
            <p className="text-sm text-gray-300">Lỡ ăn vượt — <strong style={{ color: '#fff' }}>không nhịn bữa tiếp.</strong> Quay về cấu trúc ngay:</p>
            <div className="flex flex-wrap gap-2 mt-3">
              {['Protein', 'Rau xanh', 'Nhiều nước', 'Bữa kế tiếp bình thường'].map((item) => (
                <span key={item} className="px-3 py-1 rounded-full text-xs font-semibold" style={{ background: 'rgba(132,204,22,0.12)', color: LIME }}>
                  ✓ {item}
                </span>
              ))}
            </div>
        ...
        ═══════════════════════════════════════════════════════════════════ */}
        <RevealBlock className="mb-14">
          <h2 className="text-2xl font-bold mb-2" style={{ color: '#f1f5f9' }}>3 Cấp Độ Đĩa Ăn</h2>
          <p className="text-sm text-gray-500 mb-6">Từ lý tưởng đến cứu nguy — mọi tình huống đều có giải pháp</p>
          ...
          {activePlateLevelData && (
            ...
            >
              <p className="font-bold text-lg mb-1" style={{ color: activePlateLevelData.color }}>{activePlateLevelData.label}</p>
              <p className="text-sm text-gray-400 mb-5">{activePlateLevelData.desc}</p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {activePlateLevelData.items.map((item) => (
                  ...
                  >
                    ...
                    <p className="text-xs font-bold uppercase tracking-wide" style={{ color: activePlateLevelData.color }}>{item.label}</p>
              ...
              <div className="mt-5 pt-4 border-t grid grid-cols-3 gap-3 text-xs" style={{ borderColor: 'rgba(255,255,255,0.06)' }}>
                {[
        ...
        ═══════════════════════════════════════════════════════════════════ */}
        <RevealBlock className="mb-14">
          <h2 className="text-2xl font-bold mb-2" style={{ color: '#f1f5f9' }}>10 Quy Tắc Vàng</h2>
          <p className="text-sm text-gray-500 mb-6">Tóm tắt toàn bộ hệ thống chia bữa trong 10 điểm</p>
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {SUMMARY_RULES.map((r) => (
              <RevealBlock key={r.n}>
                ...
                >
                  <div
                    className="w-9 h-9 rounded-xl flex items-center justify-center text-base flex-shrink-0 font-black"
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-0.5">
                      ...
                      <p className="text-sm font-semibold text-gray-200">{r.text}</p>
                    </div>
        ...
        ═══════════════════════════════════════════════════════════════════ */}
        <RevealBlock className="mb-14">
          <h2 className="text-2xl font-bold mb-2" style={{ color: '#f1f5f9' }}>Meal Prep Thực Tế</h2>
          <p className="text-sm text-gray-500 mb-6">Chuẩn bị theo thành phần — 2 lần/tuần, ~45 phút</p>
          ...
          <div className="mt-5 p-4 rounded-xl border flex items-start gap-3" style={{ background: 'rgba(132,204,22,0.05)', borderColor: 'rgba(132,204,22,0.15)' }}>
            ...
            <div>
              <p className="text-sm font-semibold" style={{ color: LIME }}>Tip: Theo thành phần, không theo bữa</p>
