  ...
  return (
    <div className={`rounded-2xl border p-3.5 cursor-pointer transition-all duration-200 ${active ? 'border-green-500/50 bg-green-500/8' : 'border-border/20 bg-surface/20 hover:border-border/40'}`}>
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-sm font-black shrink-0" style={{ color: item.color }}>{pG.toFixed(1)}g</span>
      </div>
    ...
    <div className="min-h-screen bg-bg text-text pb-24 px-4 max-w-3xl mx-auto pt-8 md:pt-12">
      ...
      <RevealBlock className="mb-10 relative">
        ...
        <div className="flex items-start gap-6 relative">
          <div className="w-20 h-20 rounded-3xl text-5xl bg-surface border border-green-500/20 shrink-0 flex items-center justify-center np-float">💪</div>
          <div className="flex-1">
            <h1 className="text-4xl md:text-5xl font-bold text-text leading-tight">Công Thức Tính Protein</h1>
            <span className="inline-block text-xs font-bold uppercase tracking-widest text-green-400 mt-3 mb-4 px-3 py-1 bg-green-500/10 border border-green-500/20 rounded-full">Nền Tảng Dinh Dưỡng</span>
            ...
            <div className="absolute bottom-4 left-6 flex gap-3">
              {[
                ...
                <div key={i} className="bg-bg/70 backdrop-blur-sm px-3 py-1.5 rounded-xl border border-white/10">
                  <p className="text-sm font-black" style={{ color: s.color }}>{s.label}</p>
      ...
      <RevealBlock className="mb-12">
        <div className="rounded-3xl border border-green-500/20 bg-surface/10 p-6 md:p-8 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <h2 className="text-xl font-black text-text mb-5">Protein — "Neo Chính" của mỗi bữa ăn</h2>
        ...
        <div className="space-y-8">
                ...
                {[
                  ...
                  <div key={f.key}>
                    ...
                    <input type={f.type} min={f.min} max={f.max}
                      ...
                      className="w-full bg-surface/30 border border-border/30 rounded-xl px-3 py-2 text-text text-sm font-bold focus:outline-none focus:border-green-500/50 focus:bg-surface/50 transition-colors"
                    />
                  </div>
                ))}
              </div>
          ...
          <RevealBlock delay={80}>
            <div className="rounded-3xl border border-green-500/20 bg-surface/10 p-6 md:p-8">
              ...
              <h3 className="text-lg font-black text-text mb-4">Protein = Thể trọng × Hệ số mục tiêu</h3>
              <div className="rounded-2xl bg-black/30 border border-green-500/20 p-4 font-mono text-sm mb-5 space-y-1">
          ...
          <RevealBlock delay={160}>
            <div className="rounded-3xl border border-lime-500/20 bg-surface/10 p-6">
              ...
              <div className="flex items-center gap-6 mb-4">
                ...
                <div className="flex-1">
                  <p className="text-xs text-muted mb-2">Đã nạp: <span className="font-black text-text">{currentG}g</span> / {proteinG}g mục tiêu</p>
          ...
          <RevealBlock delay={200}>
            <div className="rounded-3xl border border-cyan-500/20 bg-surface/10 p-6">
              ...
              <div className="flex items-start gap-3 mb-4">
                ...
                <div>
                  <p className="text-sm font-bold text-text">Nam 48 tuổi · 77kg · 1m75</p>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {[
                        ...
                        <div key={i} className="text-center rounded-xl bg-surface/20 p-2">
                          <p className="text-sm font-black" style={{ color: v.color }}>{v.val}</p>
                    ...
                    <div key={i} className="flex items-start gap-4 p-4 rounded-2xl border border-border/20 bg-surface/20">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-sm font-black shrink-0" style={{ color: GREEN }}>~{g}g</span>
                        </div>
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4 pl-16 relative">
                      ...
                      <div className="flex-1 flex items-center justify-between">
                        ...
                        <span className="text-xs font-black" style={{ color: ev.color }}>{ev.g}g</span>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <RevealBlock key={i} delay={i * 80}>
              <div className="rounded-3xl border p-6" style={{ borderColor: lv.color + '30', background: lv.color + '06' }}>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <p className="text-lg font-black text-text">{lv.level}</p>
                    <p className="text-[9px]" style={{ color: lv.color }}>{lv.sub}</p>
                  </div>
                  <div className="ml-auto text-right">
                    <p className="text-lg font-black" style={{ color: lv.color }}>{lv.pct}</p>
          ...
          <RevealBlock delay={280}>
            <div className="rounded-3xl border border-lime-500/20 bg-lime-500/4 p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-black text-lime-400 mb-2">Nguyên Tắc 80/20 — Đừng Ám Ảnh</p>
              ...
              <div className="rounded-3xl border border-border/20 bg-surface/10 p-5 md:p-6 relative overflow-hidden">
                ...
                <div className="relative">
                  <div className="flex items-start gap-3 mb-3">
                    <div className="w-8 h-8 rounded-xl bg-red-500/10 border border-red-500/20 flex items-center justify-center text-sm shrink-0">❌</div>
                    <div>
                      <p className="text-[9px] text-red-400 font-bold uppercase tracking-wider mb-1">Hiểu lầm #{i + 1}</p>
                      <p className="text-sm font-bold text-text">"{m.myth}"</p>
                    </div>
                  </div>
      ...
      <RevealBlock className="mb-8">
        <div className="grid md:grid-cols-3 gap-4">
          <Link to="/pillar/b/formula" className="group rounded-2xl border border-green-500/20 bg-green-500/4 p-4 hover:border-green-500/40 transition-all">
            ...
            <p className="text-xs font-bold text-green-400">Công Thức Meal Plan</p>
          </Link>
          <Link to="/pillar/b" className="group rounded-2xl border border-lime-500/20 bg-lime-500/4 p-4 hover:border-lime-500/40 transition-all text-center">
            ...
            <p className="text-xs font-bold text-lime-400">Dinh Dưỡng & Thực Đơn</p>
          </Link>
          <Link to="/pillar/b/data" className="group rounded-2xl border border-purple-500/20 bg-purple-500/4 p-4 hover:border-purple-500/40 transition-all text-right">
            ...
            <p className="text-xs font-bold text-purple-400">Cấu Trúc Dữ Liệu</p>
          </Link>
        </div>
      </RevealBlock>
