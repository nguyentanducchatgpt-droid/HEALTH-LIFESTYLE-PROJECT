  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <div className="text-center">
        <div className="font-bold text-lg" style={{ color: tierColor }}>{tier}</div>
        <div className="text-base text-gray-500 mt-1">{phaseRange}</div>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="n24-fade-up rounded-2xl border p-6 mt-4"
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4">
        <span className="text-4xl">{wk.emoji}</span>
        <div>
          <h3 className="font-bold text-xl text-white">Tuần {wk.n}: {wk.title}</h3>
      ...
      <p className="text-lg italic mb-3" style={{ color: wk.color }}>{wk.tagline}</p>
      <div className="text-lg text-gray-300 mb-5 p-3 rounded-xl" style={{ background: `rgba(${wk.rgb},0.07)` }}>
      ...
      {wk.plate && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Đĩa Ăn Dự Án</div>
          <div className="grid grid-cols-2 gap-2">
            {wk.plate.map((p,i) => (
              <div key={i} className="flex items-start gap-2 p-2.5 rounded-lg bg-black/30 border border-white/5">
                <span className="text-base font-bold px-1.5 py-0.5 rounded" style={{ background: `${p.color}22`, color: p.color }}>{p.part}</span>
                <span className="text-base text-gray-300">{p.label}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {wk.proteins && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Nguồn Đạm</div>
          <div className="grid grid-cols-2 gap-2">
            {wk.proteins.map((p,i) => (
              <div key={i} className="p-2.5 rounded-lg bg-black/30 border border-white/5">
                <div className="text-base font-semibold" style={{ color: wk.color }}>{p.group}</div>
                <div className="text-base text-gray-400 mt-0.5">{p.items}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {wk.rules && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Nguyên Tắc</div>
      ...
      {wk.formula && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Công Thức Năng Lượng</div>
          <div className="rounded-xl overflow-hidden border border-white/5">
            {wk.formula.map((f,i) => (
              <div key={i} className={`flex gap-3 px-3 py-2.5 text-lg ${i%2===0?'bg-black/20':'bg-black/10'}`}>
      ...
      {wk.macros && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Vai Trò Macro</div>
          <div className="space-y-2">
            {wk.macros.map((m,i) => (
              <div key={i} className="p-3 rounded-xl bg-black/30 border border-white/5">
                <div className="font-semibold text-lg" style={{ color: wk.color }}>{m.macro}</div>
                <div className="text-base text-gray-400 mt-0.5">{m.role}</div>
                <div className="text-base text-gray-500 mt-0.5">Khi nào: {m.when}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {wk.handParts && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Khẩu Phần Bàn Tay</div>
          <div className="grid grid-cols-2 gap-2">
            {wk.handParts.map((hp,i) => (
              <div key={i} className="flex justify-between p-2.5 rounded-lg bg-black/30 border border-white/5">
                <span className="text-base font-semibold" style={{ color: wk.color }}>{hp.part}</span>
                <span className="text-base text-gray-400">{hp.measure}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {wk.adjust && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Điều Chỉnh Theo Mục Tiêu</div>
          {wk.adjust.map((a,i) => (
            <div key={i} className="flex gap-2 text-lg py-1.5 border-b border-white/5 last:border-0">
      ...
      {wk.bodyFeedback && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Tín Hiệu Cơ Thể</div>
          <div className="rounded-xl overflow-hidden border border-white/5">
            {wk.bodyFeedback.map((f,i) => (
              <div key={i} className={`flex gap-3 px-3 py-2.5 text-base ${i%2===0?'bg-black/20':'bg-black/10'}`}>
      ...
      {wk.review && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Tổng Kết Tháng 1</div>
          <div className="rounded-xl overflow-hidden border border-white/5">
            {wk.review.map((r,i) => (
              <div key={i} className={`flex gap-3 px-3 py-2.5 text-base ${i%2===0?'bg-black/20':'bg-black/10'}`}>
      ...
      {wk.meals && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Gợi Ý Bữa Ăn</div>
          <div className="space-y-1.5">
            {wk.meals.map((m,i) => (
              <div key={i} className="flex gap-3 text-lg p-2.5 rounded-lg bg-black/20">
      ...
      {wk.timing && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Thời Điểm Ăn</div>
          {wk.timing.map((t,i) => (
            <div key={i} className="p-2.5 rounded-lg bg-black/20 mb-1.5">
              <div className="text-base font-semibold" style={{ color: wk.color }}>{t.time}</div>
              <div className="text-base text-gray-400 mt-0.5">{t.food}</div>
            </div>
          ))}
        </div>
      )}
      ...
      {wk.testMetrics && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Chỉ Số Đánh Giá</div>
          <div className="flex flex-wrap gap-2">
            {wk.testMetrics.map((m,i) => (
              <span key={i} className="text-base px-2 py-1 rounded-full bg-black/30 border border-white/10 text-gray-300">{m}</span>
            ))}
          </div>
        </div>
      )}
      ...
      {wk.directions && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Hướng Đi Tiếp Theo</div>
          <div className="rounded-xl overflow-hidden border border-white/5">
      ...
      {wk.mealBoxes && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Công Thức Hộp Cơm</div>
          <div className="grid grid-cols-2 gap-2">
            {wk.mealBoxes.map((b,i) => (
              <div key={i} className="p-3 rounded-xl bg-black/30 border border-white/5 text-base">
      ...
      {wk.eatOutRules && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Quy Tắc Ăn Ngoài</div>
          {wk.eatOutRules.map((r,i) => (
            <div key={i} className="p-2.5 rounded-lg bg-black/20 mb-1.5">
              <span className="font-semibold text-base" style={{ color: wk.color }}>{r.place}: </span>
              <span className="text-base text-gray-300">{r.rule}</span>
            </div>
          ))}
        </div>
      )}
      ...
      {wk.dontDo && (
        <div className="mb-5 grid grid-cols-2 gap-3">
          <div>
            <div className="text-base font-bold uppercase tracking-wider text-red-400 mb-2">Không Nên</div>
            <ul className="space-y-1">
              {wk.dontDo.map((d,i) => <li key={i} className="text-base text-gray-400 flex gap-1.5"><span className="text-red-400">✗</span>{d}</li>)}
            </ul>
          </div>
          <div>
            <div className="text-base font-bold uppercase tracking-wider text-green-400 mb-2">Nên Làm</div>
            <ul className="space-y-1">
              {wk.doDo.map((d,i) => <li key={i} className="text-base text-gray-400 flex gap-1.5"><span className="text-green-400">✓</span>{d}</li>)}
            </ul>
          </div>
        </div>
      )}
      ...
      {wk.quickMeals && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Bữa Ăn Nhanh</div>
          {wk.quickMeals.map((q,i) => (
            <div key={i} className="mb-2">
              <div className="text-base font-semibold mb-1" style={{ color: wk.color }}>{q.type}</div>
              <div className="flex flex-wrap gap-1.5">
                {q.options.map((o,j) => (
                  <span key={j} className="text-base px-2 py-1 rounded-full bg-black/30 border border-white/10 text-gray-300">{o}</span>
                ))}
              </div>
            </div>
          ))}
      ...
      {wk.carbRules && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Carb Theo Ngày</div>
          {wk.carbRules.map((c,i) => (
            <div key={i} className="flex gap-3 text-lg py-1.5 border-b border-white/5 last:border-0">
      ...
      {wk.waterRules && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Uống Nước Theo Tình Huống</div>
          ...
          {wk.warnings && (
            <div className="mt-2">
              <div className="text-base text-red-400 font-semibold mb-1">Dấu hiệu thiếu nước:</div>
              <div className="flex flex-wrap gap-1.5">
                {wk.warnings.map((w,i) => <span key={i} className="text-base px-2 py-1 rounded-full bg-red-900/20 border border-red-800/30 text-red-400">{w}</span>)}
              </div>
            </div>
          )}
        </div>
      ...
      {wk.goodFats && (
        <div className="mb-5 grid grid-cols-2 gap-3">
          <div>
            <div className="text-base font-bold uppercase tracking-wider text-green-400 mb-2">Fat Tốt</div>
            <ul className="space-y-1">
              {wk.goodFats.map((f,i) => <li key={i} className="text-base text-gray-400 flex gap-1.5"><span className="text-green-400">+</span>{f}</li>)}
            </ul>
          </div>
          <div>
            <div className="text-base font-bold uppercase tracking-wider text-red-400 mb-2">Hạn Chế</div>
            <ul className="space-y-1">
              {wk.limitFats.map((f,i) => <li key={i} className="text-base text-gray-400 flex gap-1.5"><span className="text-red-400">−</span>{f}</li>)}
            </ul>
          </div>
        </div>
      )}
      ...
      {wk.sleepEffects && (
        <div className="mb-5 grid grid-cols-2 gap-3">
          <div>
            <div className="text-base font-bold uppercase tracking-wider text-red-400 mb-2">Khi Thiếu Ngủ</div>
            <ul className="space-y-1">
              {wk.sleepEffects.map((e,i) => <li key={i} className="text-base text-gray-400 flex gap-1.5"><span className="text-red-400">!</span>{e}</li>)}
            </ul>
          </div>
          <div>
            <div className="text-base font-bold uppercase tracking-wider text-green-400 mb-2">Routine Tối</div>
            <ul className="space-y-1">
              {wk.nightRoutine.map((r,i) => <li key={i} className="text-base text-gray-400 flex gap-1.5"><span className="text-green-400">✓</span>{r}</li>)}
            </ul>
          </div>
        </div>
      )}
      ...
      {wk.menuSteps && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Các Bước Lên Thực Đơn</div>
          <ol className="space-y-1.5">
            {wk.menuSteps.map((s,i) => (
              <li key={i} className="text-lg text-gray-300 flex gap-2">
                <span className="w-5 h-5 rounded-full text-base font-bold flex items-center justify-center shrink-0" style={{ background: `rgba(${wk.rgb},0.2)`, color: wk.color }}>{i+1}</span>
                {s}
              </li>
            ))}
          </ol>
      ...
      {wk.dayFrame && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Khung Ngày</div>
          {wk.dayFrame.map((d,i) => (
            <div key={i} className="flex gap-3 text-lg py-1.5 border-b border-white/5 last:border-0">
      ...
      {wk.plateauCheck && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Checklist Plateau</div>
          <ul className="space-y-1.5 mb-3">
            {wk.plateauCheck.map((c,i) => (
              <li key={i} className="text-base text-gray-300 flex gap-2 items-center">
          ...
          {wk.plateauFix && (
            <>
              <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Cách Xử Lý</div>
              {wk.plateauFix.map((f,i) => (
                <div key={i} className="p-2.5 rounded-lg bg-black/20 mb-1.5">
                  <div className="text-base font-semibold" style={{ color: wk.color }}>{f.goal}</div>
                  <div className="text-base text-gray-400 mt-0.5">{f.fix}</div>
                </div>
              ))}
            </>
          )}
      ...
      {wk.rule8020 && (
        <div className="mb-5 grid grid-cols-2 gap-3">
          {wk.rule8020.map((r,i) => (
            <div key={i} className="p-3 rounded-xl bg-black/30 border border-white/5">
              <div className="text-base font-semibold mb-2" style={{ color: wk.color }}>{r.type}</div>
              <ul className="space-y-1">
                {r.items.map((item,j) => <li key={j} className="text-base text-gray-400">• {item}</li>)}
              </ul>
            </div>
          ))}
        </div>
      ...
      {wk.partyStrategy && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Chiến Thuật Đi Tiệc</div>
          {wk.partyStrategy.map((p,i) => (
            <div key={i} className="p-2.5 rounded-lg bg-black/20 mb-1.5">
              <span className="font-semibold text-base" style={{ color: wk.color }}>{p.time}: </span>
              <span className="text-base text-gray-300">{p.action}</span>
            </div>
          ))}
        </div>
      )}
      ...
      {wk.reviewMetrics && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Chỉ Số Tổng Kết</div>
          <div className="flex flex-wrap gap-2">
            {wk.reviewMetrics.map((m,i) => (
              <span key={i} className="text-base px-2.5 py-1 rounded-full border font-medium" style={{ borderColor:`${wk.color}44`, color: wk.color, background:`rgba(${wk.rgb},0.08)` }}>{m}</span>
            ))}
          </div>
        </div>
      )}
      ...
      {wk.next3Paths && (
        <div className="mb-5">
          <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">3 Hướng Tiếp Theo</div>
          <div className="space-y-3">
            {wk.next3Paths.map((p,i) => (
              <div key={i} className="p-3 rounded-xl bg-black/30 border border-white/5">
                <div className="font-semibold text-lg" style={{ color: wk.color }}>{p.path}</div>
                <div className="text-base text-gray-500 mb-2">{p.who}</div>
                <ul className="space-y-1">
                  {p.strategy.map((s,j) => <li key={j} className="text-base text-gray-400 flex gap-1.5"><span style={{ color: wk.color }}>▸</span>{s}</li>)}
                </ul>
              </div>
            ))}
          </div>
      ...
      {/* Tasks */}
      <div className="mb-4">
        <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">Nhiệm Vụ Tuần Này</div>
          ...
          {wk.tasks.map((t, i) => (
            <li key={i}
              ...
              <span className={`w-4 h-4 rounded border mt-0.5 flex items-center justify-center shrink-0 transition-all ${checkedTasks[i] ? 'border-amber-500 bg-amber-500' : 'border-gray-600 group-hover:border-amber-400'}`}>
                {checkedTasks[i] && <span className="text-black text-base font-bold">✓</span>}
              </span>
              <span className={`text-lg transition-colors ${checkedTasks[i] ? 'line-through text-gray-600' : 'text-gray-300 group-hover:text-white'}`}>{t}</span>
            </li>
          ))}
        </ul>
      </div>
      ...
      {/* KPI */}
      <div>
        <div className="text-base font-bold uppercase tracking-wider text-gray-400 mb-2">KPI Tuần</div>
        <ul className="space-y-1.5">
          {wk.kpi.map((k, i) => (
            <li key={i} className="text-base text-gray-400 flex gap-2 items-start">
  ...
  return (
    <div className="min-h-screen" style={{ background: '#0a0a0a', color: '#e5e7eb' }}>
      <div className="px-4 md:px-6 max-w-4xl mx-auto pt-28 md:pt-32 pb-24">
        ...
        {/* Breadcrumb */}
        <Link to="/pillar/b" className="inline-flex items-center gap-1.5 text-lg text-gray-500 hover:text-amber-400 transition-colors mb-8">
          ← Dinh Dưỡng
        </Link>
        ...
        <div className="flex items-start gap-6 mb-10 relative">
          ...
          <div className="w-20 h-20 rounded-3xl text-6xl flex items-center justify-center shrink-0 border n24-float"
            style={{ background: '#111', borderColor: 'rgba(245,158,11,0.2)' }}>
            🗓️
          </div>
          <div>
            <h1 className="text-5xl md:text-6xl font-bold leading-tight n24-fade-up" style={{ color: '#e5e7eb' }}>
              Lộ trình Nutrition <span style={{ color: '#f59e0b' }}>24 Tuần</span>
            </h1>
            <span className="inline-block text-base font-bold uppercase tracking-widest mt-3 mb-4 px-3 py-1 rounded-full border"
            ...
            {heroStats.map((s, i) => (
              <div key={i} className="group/stat relative flex flex-col items-center">
                ...
                <div className="w-28 h-28 rounded-2xl border flex flex-col items-center justify-center cursor-default"
                  ...
                  <span className="text-4xl font-bold" style={{ color: '#f59e0b' }}>{s.n}{s.suffix}</span>
                  <span className="text-base text-gray-400 mt-1 text-center px-2">{s.label}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <RevealBlock className="mb-16">
          <div className="rounded-2xl p-6 border" style={{ background: 'linear-gradient(135deg, rgba(245,158,11,0.08), rgba(245,158,11,0.03))', borderColor: 'rgba(245,158,11,0.25)' }}>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-bold text-lg" style={{ color: '#f59e0b' }}>Thông Số Cá Nhân Của Bạn</h2>
            </div>
            <p className="text-lg text-gray-400 mb-5">Lộ trình dưới đây được cá nhân hóa cho bạn.</p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
              {[
                ...
                <div key={i} className="p-3 rounded-xl bg-black/40 text-center">
                  <div className="text-xl font-bold" style={{ color: '#f59e0b' }}>{item.value}</div>
                  <div className="text-base text-gray-500 mt-1">{item.label}</div>
                </div>
              ))}
            </div>
            <p className="text-base text-gray-600 mt-3">Dữ liệu từ B0 · {b0.w}kg · {b0.h}cm · {b0.age}t · {b0.sx === 'female' ? 'Nữ' : 'Nam'}</p>
          </div>
        </RevealBlock>

        {/* Section 2 — Objectives */}
        <RevealBlock className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-6">Bạn Sẽ Học Được Gì?</h2>
          <div className="grid md:grid-cols-2 gap-3">
            {objectives.map((o, i) => (
              <div key={i} className="flex items-start gap-3 p-4 rounded-xl border border-white/5 bg-white/[0.02] hover:border-amber-500/20 transition-colors">
                ...
                <span className="text-lg text-gray-300">{o.text}</span>
              </div>
            ))}
          </div>
        </RevealBlock>
        ...
        <RevealBlock className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-6">4 Nguyên Tắc Cốt Lõi</h2>
          <div className="space-y-3">
            {principles.map((p) => (
              <div key={p.id} className="rounded-2xl border border-white/5 overflow-hidden">
                <button
                  ...
                  <span className="font-semibold text-lg text-white flex-1">{p.title}</span>
                  <span className="text-gray-500 text-base">{openPrinciple === p.id ? '▲' : '▼'}</span>
                </button>
                {openPrinciple === p.id && (
                  <div className="px-5 pb-5">
                    {p.id === 3 ? (
                      <div>
                        <p className="text-lg text-gray-400 mb-4">Mỗi giai đoạn xây trên nền của giai đoạn trước. Không nhảy cóc.</p>
                        {/* Staircase SVG */}
                      ...
                      <p className="text-lg text-gray-400">{p.body}</p>
                    )}
                  </div>
                )}
              </div>
        ...
        <RevealBlock className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-6">Chỉ Số Theo Dõi</h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl border border-white/5 p-5">
              <div className="text-base font-bold uppercase tracking-wider mb-4" style={{ color: '#f59e0b' }}>Hàng Ngày (7 chỉ số)</div>
              <div className="space-y-2.5">
                {[
                  ...
                  <div key={i} className="flex items-center gap-2.5 text-lg text-gray-300">
            ...
            <div className="rounded-2xl border border-white/5 p-5">
              <div className="text-base font-bold uppercase tracking-wider mb-4" style={{ color: '#f59e0b' }}>Hàng Tuần (9 chỉ số)</div>
              <div className="space-y-2.5">
                {[
        ...
        {/* Section 5 — 6 Phases */}
        <RevealBlock className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-6">6 Giai Đoạn</h2>
          <div className="flex gap-3 overflow-x-auto pb-3 mb-4">
            {PHASES.map((ph) => (
              <button key={ph.id}
                ...
                <div className="text-3xl mb-2">{ph.emoji}</div>
                <div className="text-base text-gray-500 mb-1">Giai Đoạn {ph.id} · Tuần {ph.weeks}</div>
                <div className="font-semibold text-lg" style={{ color: ph.color }}>{ph.label}</div>
                <div className="text-base text-gray-600 mt-1">{ph.scoreTarget}</div>
              </button>
            ))}
          </div>
              ...
              <div className="n24-fade-up rounded-2xl p-5 border"
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <div className="text-base text-gray-500">Tuần {ph.weeks} · {ph.scoreTarget}</div>
                  </div>
                </div>
                <p className="text-lg text-gray-400 mb-3">{ph.goal}</p>
                <p className="text-lg text-gray-500 mb-4">{ph.desc}</p>
                <div className="flex flex-wrap gap-2">
                  {ph.weekNums.map(n => (
                    <button key={n}
                      className="text-base px-3 py-1.5 rounded-full border font-medium transition-all hover:scale-105"
        ...
        <RevealBlock className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-6">24 Tuần Chi Tiết</h2>
          <div className="grid grid-cols-4 md:grid-cols-6 gap-2 mb-4">
            {WEEKS.map((wk) => (
              <button key={wk.n}
                ...
                <span className="text-lg font-bold" style={{ color: wk.color }}>{wk.n}</span>
        ...
        <RevealBlock className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-6">Habit Score Hôm Nay</h2>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-start">
                ...
                {HABIT_SCORE_CRITERIA.map((c) => (
                  <label key={c.id} className="flex items-start gap-3 cursor-pointer group">
                    <div
                      ...
                      {habitChecked[c.id] && <span className="text-black text-base font-bold">✓</span>}
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center justify-between">
                        <span className="text-lg font-medium text-white">{c.icon} {c.label}</span>
                        <span className="text-base font-bold" style={{ color: '#f59e0b' }}>+{c.pts}pt</span>
                      </div>
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <div className="mt-4 w-full rounded-xl p-3 text-center"
                  ...
                  <div className="text-base text-gray-500">Tổng điểm</div>
                  <div className="text-3xl font-bold mt-1" style={{ color: '#f59e0b' }}>{habitScore} / 100</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <RevealBlock className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-6">Bảng Tổng Hợp 24 Tuần</h2>
          <div className="rounded-2xl border border-white/5 overflow-hidden">
            <div className="grid grid-cols-4 text-base font-bold uppercase tracking-wider text-gray-500 px-4 py-3 bg-white/[0.02] border-b border-white/5">
            ...
            {SUMMARY_TABLE.map((row) => {
              ...
              return (
                <button key={row.n} className="w-full grid grid-cols-4 text-left px-4 py-3 border-b border-white/[0.03] hover:bg-white/[0.03] transition-colors text-lg"
                  ...
                  <span className="text-gray-500 text-base">{row.action}</span>
                </button>
              );
            })}
          </div>
        ...
        <RevealBlock className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-6">Sau 24 Tuần — 3 Hướng Đi</h2>
          <div className="space-y-3">
              ...
              return (
                <div key={i} className="rounded-2xl border overflow-hidden"
                  ...
                  <button className="w-full flex items-center justify-between p-4 text-left hover:bg-white/[0.02] transition-colors"
                    ...
                    <div>
                      <div className="font-bold text-lg" style={{ color: cols[i] }}>{p.path}</div>
                      <div className="text-base text-gray-500 mt-0.5">{p.who}</div>
                    </div>
                    <span className="text-gray-500 text-base">{openPath === i ? '▲' : '▼'}</span>
                  </button>
                  {openPath === i && (
                    <div className="px-5 pb-5 pt-1" style={{ background: `rgba(${rgbs[i]},0.04)` }}>
                      <ul className="space-y-2">
                        {p.strategy.map((s, j) => (
                          <li key={j} className="flex items-start gap-2 text-lg text-gray-300">
        ...
        <RevealBlock>
          <div className="rounded-2xl border p-5" style={{ borderColor: 'rgba(245,158,11,0.25)', background: 'rgba(245,158,11,0.05)' }}>
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="font-bold text-lg mb-2" style={{ color: '#f59e0b' }}>Lưu Ý Quan Trọng</div>
