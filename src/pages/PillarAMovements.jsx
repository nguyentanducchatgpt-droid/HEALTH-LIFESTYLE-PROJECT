    ...
    <div className="max-w-5xl mx-auto -mt-4">
      ...
      <div className="relative -mx-4 md:-mx-8 overflow-hidden mb-10" style={{ minHeight: 230 }}>
        ...
        <div className="relative z-10 px-4 md:px-8 pt-10 pb-8 animate-fade-in-up">
          ...
          <div className="inline-flex items-center gap-2 bg-green-500/8 border border-green-500/20 text-green-400 text-xs font-bold px-4 py-1.5 rounded-full mb-5">
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            {[
              ...
              <div key={s.label} className="flex items-center gap-2 bg-surface/70 backdrop-blur-sm border border-border/60 px-3 py-2 rounded-xl">
                <span className="text-green-400 font-extrabold text-sm leading-none">{s.n}</span>
                  ...
                  <div className="grid md:grid-cols-[300px_1fr] gap-6">
                    <div className="space-y-4">
                      <div className="flex items-center gap-3">
                        <div className={`w-10 h-10 rounded-xl ${s.bg} border ${s.border} flex items-center justify-center text-xl shrink-0`}>{currentMove.icon}</div>
                        <div>
      ...
      <div className="flex items-center justify-between py-8 border-t border-border/40 mt-4 mb-4">
        ...
        <Link
          to="/pillar/a"
          className="flex items-center gap-2 text-xs bg-surface border border-border rounded-xl px-4 py-2 text-muted hover:text-text hover:border-green-500/30 transition-all"
        >
          <span>↩</span>
