    ...
    <RevealBlock className="mb-7">
      ...
      >
        ...
        <div className="relative md:w-[60%] px-7 py-8 md:px-10 md:py-10">
          ...
          {/* Title */}
          <h3 className="text-4xl md:text-5xl font-black text-white leading-snug mb-3">
            {title}{accent && <> <span style={{ color }}>{accent}</span></>}
          </h3>

          {/* Description */}
          <p className="text-lg text-gray-400 leading-relaxed mb-6 max-w-lg">{desc}</p>
          ...
          <div className="flex items-center gap-7 flex-wrap">
            <span
              className="inline-flex items-center gap-2 text-lg font-bold px-5 py-2.5 rounded-full transition-all duration-300 group-hover:gap-3 shrink-0"
            ...
            <div className="flex gap-6">
              {stats.map((s, i) => (
                <div key={i} className="text-center">
                  <div className="text-3xl md:text-4xl font-black leading-none" style={{ color }}>{s.value}</div>
...
function HeroCounter({ n, suffix, label }) {
  ...
  return (
    <div className="flex flex-col items-center">
      <span className="text-5xl md:text-6xl font-black text-lime-400 leading-none">
        {val}{suffix}
      </span>
    ...
    >
      ...
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className={`text-lg font-bold ${macro.text}`}>{displayName}</p>
            <p className="text-[10px] text-muted leading-none mt-0.5">{displayDose}</p>
          </div>
        </div>
        <div className="text-right">
          <p className={`text-xl font-black ${macro.text} leading-none`}>
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between mb-3">
        ...
        <span className={`text-base font-black ${macro.text}`}>{macro.pct}%</span>
      </div>
      ...
      <div className="space-y-3 mt-2">
        {PLATE_SECTIONS.map((s, i) => (
          <div key={s.label} className="flex items-center gap-3">
            ...
            <span className={`text-base font-semibold ${s.text} w-28 shrink-0`}>{tPillars(`pillarB.plate_sections.${i}.label`, { defaultValue: s.label })}</span>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <div>
          <p className={`text-lg font-bold ${active ? goal.text : 'text-text'}`}>{goal.label}</p>
      ...
      <div className="p-5">
        ...
        <div className="flex items-start justify-between gap-3 mb-5">
          ...
          <button
            type="button"
            onClick={onClose}
            className="w-7 h-7 rounded-lg border border-border/40 text-muted hover:text-text hover:border-border flex items-center justify-center text-lg transition-all duration-150 shrink-0 cursor-pointer"
          >✕</button>
        </div>
            ...
            {evaluation && (
              <div className="rounded-xl p-3 border" style={{ borderColor: `${evaluation.color}30`, background: `${evaluation.color}08` }}>
                <div className="flex items-center gap-2 mb-1.5">
                  <span className="text-xl">{evaluation.icon}</span>
                  <span className="text-base font-bold" style={{ color: evaluation.color }}>{evaluation.label}</span>
                </div>
          ...
          <div className="px-5 py-3.5 border-b border-white/5 flex flex-wrap items-center gap-x-6 gap-y-1">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xl font-black text-lime-400 leading-none">{s.tdee.toLocaleString()} kcal<span className="text-[9px] text-muted font-normal ml-1">/ngày</span></p>
              </div>
            </div>
            ...
            {translatedModes.map(m => {
              ...
              return (
                ...
                >
                  ...
                  {/* Arrow */}
                  <div className="text-5xl font-black mb-1 transition-transform duration-200 group-hover:scale-110" style={{ color: m.color }}>{m.arrow}</div>
                  {/* Label */}
                  <p className="text-base font-black mb-1" style={{ color: m.color }}>{m.label}</p>
                  {/* Animated kcal */}
                  <p className="text-lg font-black text-text leading-none mb-0.5">
      ...
      <RevealBlock delay={130}>
        <div className="mt-2">
          <div className="flex items-center gap-3 mb-5">
            <div className="w-10 h-10 rounded-xl bg-lime-500/12 border border-lime-500/25 flex items-center justify-center text-3xl shrink-0">💎</div>
            <div>
              <p className="text-lg font-bold text-text">{b1tr.philosophy_title || '7 Công Thức Triết Lý Dinh Dưỡng'}</p>
          ...
          <div className="rounded-2xl border border-lime-500/20 bg-lime-500/5 px-5 py-3.5 mb-5 text-center">
            <p className="text-lg font-bold text-lime-400 italic leading-relaxed">
    ...
    <div>
      ...
      <div ref={ref} className="grid md:grid-cols-2 gap-8 items-start mb-10">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-lime-500/20 bg-lime-500/5 p-5">
            <p className="text-base font-bold text-lime-400 mb-3">{b2tr.at_home || '🏠 Tại nhà'}</p>
            <ul className="space-y-2">
          ...
          <div className="rounded-2xl border border-orange-500/20 bg-orange-500/5 p-5">
            <p className="text-base font-bold text-orange-400 mb-3">{b2tr.eating_out || '🍜 Ăn ngoài hàng'}</p>
            <ul className="space-y-2">
          ...
          <div className="rounded-2xl border border-cyan-500/20 bg-cyan-500/5 p-5">
            <p className="text-base font-bold text-cyan-400 mb-3">{b2tr.meal_prep || '📦 Meal Prep bận rộn'}</p>
            <ul className="space-y-2">
      ...
      <RevealBlock>
        <div className="rounded-2xl overflow-hidden mb-8 relative h-44 md:h-56">
          ...
          <div className="absolute inset-y-0 left-0 px-7 flex flex-col justify-center max-w-sm">
            ...
            <p className="text-3xl font-black text-text leading-tight mb-1.5">{b2tr.golden_title || 'Đạm → Rau → Tinh bột'}</p>
      ...
      <RevealBlock delay={40}>
        <div className="rounded-2xl border border-border/25 p-6 mb-8" style={{ background: 'rgba(255,255,255,0.015)' }}>
          <div className="flex items-start gap-3 mb-5">
            <div className="w-9 h-9 rounded-xl bg-lime-500/15 border border-lime-500/25 flex items-center justify-center text-3xl shrink-0">✋</div>
            <div>
              <h3 className="text-lg font-bold text-text">{b2tr.hand_title || 'Công Thức Khẩu Phần Theo Tay — Không Cần Cân'}</h3>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
            {[
              ...
              <div key={i} className="rounded-xl border p-3.5 text-center" style={{ borderColor: `${p.color}28`, background: `${p.color}07` }}>
                <div className="text-5xl mb-2">{p.hand}</div>
      ...
      <div className="grid sm:grid-cols-2 gap-5 mb-8">
        ...
        <RevealBlock delay={60}>
          <div className="rounded-2xl border border-lime-500/20 bg-lime-500/5 p-5 h-full">
            <h3 className="text-lg font-bold text-lime-400 mb-0.5 flex items-center gap-2">{b2tr.protein_anchor_title || '💪 Protein — "Neo" Mỗi Bữa'}</h3>
        ...
        <RevealBlock delay={100}>
          <div className="rounded-2xl border border-orange-500/20 bg-orange-500/5 p-5 h-full">
            <h3 className="text-lg font-bold text-orange-400 mb-0.5 flex items-center gap-2">{b2tr.carb_timing_title || '⚡ Carb Đúng Thời Điểm'}</h3>
      ...
      <RevealBlock delay={120}>
        <div className="rounded-2xl border border-white/8 p-6 mb-2" style={{ background: 'rgba(255,255,255,0.02)' }}>
          <div className="flex items-center gap-3 mb-5">
            <div className="w-10 h-10 rounded-xl border flex items-center justify-center text-3xl shrink-0" style={{ background: 'rgba(168,85,247,0.12)', borderColor: 'rgba(168,85,247,0.25)' }}>🎯</div>
            <div>
              <h3 className="text-lg font-bold text-text">{b2tr.rule_8020_title || 'Nguyên Tắc 80/20 — Linh Hoạt Để Bền Vững'}</h3>
          ...
          <div className="grid sm:grid-cols-2 gap-5 mb-5">
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-base font-black text-green-400 shrink-0">80%</span>
              </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-base font-black text-purple-400 shrink-0">20%</span>
              </div>
      ...
      <RevealBlock delay={140}>
        <div className="rounded-2xl border border-border/25 p-6 mb-8" style={{ background: 'rgba(255,255,255,0.015)' }}>
          <div className="flex items-start gap-3 mb-5">
            <div className="w-9 h-9 rounded-xl bg-green-500/12 border border-green-500/20 flex items-center justify-center text-3xl shrink-0">❓</div>
            <div>
              <h3 className="text-lg font-bold text-text">{b2tr.check_q_title || '4 Câu Hỏi Kiểm Tra Mỗi Bữa'}</h3>
            ...
            {(toArr(b2tr.check_questions).length ? toArr(b2tr.check_questions) : MEAL_CHECK_QUESTIONS).map((q, i) => (
              <RevealBlock key={i} delay={i * 50}>
                <div className="rounded-xl border p-4 flex items-start gap-3" style={{ borderColor: `${MEAL_CHECK_QUESTIONS[i]?.color || '#84cc16'}25`, background: `${MEAL_CHECK_QUESTIONS[i]?.color || '#84cc16'}06` }}>
                  <span className="text-4xl shrink-0">{MEAL_CHECK_QUESTIONS[i]?.icon || '•'}</span>
      ...
      <RevealBlock delay={160}>
        <div className="mb-8">
          <div className="flex items-start gap-3 mb-5">
            <div className="w-9 h-9 rounded-xl bg-cyan-500/12 border border-cyan-500/20 flex items-center justify-center text-3xl shrink-0">🔀</div>
            <div>
              <h3 className="text-lg font-bold text-text">{b2tr.swap_title || 'Bảng Thay Thế Thực Phẩm'}</h3>
              ...
              <RevealBlock key={group.label}>
                <div className="rounded-2xl border p-4 h-full" style={{ borderColor: `${group.color}25`, background: `${group.color}05` }}>
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <p className="text-base font-bold" style={{ color: group.color }}>{translatedLabel}</p>
                  </div>
                  <div className="space-y-3">
      ...
      <RevealBlock delay={180}>
        <div className="mb-2">
          <div className="flex items-start gap-3 mb-5">
            <div className="w-9 h-9 rounded-xl bg-orange-500/12 border border-orange-500/20 flex items-center justify-center text-3xl shrink-0">🏪</div>
            <div>
              <h3 className="text-lg font-bold text-text">{b2tr.eating_out_title || 'Ăn Ngoài Vẫn Khỏe — Quy Tắc 3 Chọn'}</h3>
    ...
    <div>
      ...
      <div key={activeGoal} className="animate-fade-in-up">
        <div className="rounded-2xl border p-5 mb-4" style={{ borderColor: `${activeG?.color}22`, background: `${activeG?.color}05` }}>
          <p className="text-lg font-bold text-text mb-1.5">{analysis.headline}</p>
      ...
      <div className="rounded-2xl border p-5 mb-2" style={{ borderColor: 'rgba(249,115,22,0.2)', background: 'rgba(249,115,22,0.03)' }}>
        ...
        <div className="flex flex-col sm:flex-row items-stretch gap-2">
          ...
          <div className="flex-1 text-center rounded-xl border p-3.5" style={{ borderColor: 'rgba(249,115,22,0.2)', background: 'rgba(249,115,22,0.05)' }}>
            ...
            <p className="text-4xl font-black leading-none" style={{ color: '#f97316' }}>{s.bmr.toLocaleString()}</p>
          ...
          <div className="flex sm:flex-col items-center justify-center px-1 py-1 sm:py-0">
            ...
            <div className="text-3xl" style={{ color: '#f97316' }}>→</div>
          ...
          <div className="flex-1 text-center rounded-xl border p-3.5" style={{ borderColor: 'rgba(249,115,22,0.3)', background: 'rgba(249,115,22,0.07)' }}>
            ...
            <p className="text-4xl font-black leading-none" style={{ color: '#f97316' }}>{s.tdee.toLocaleString()}</p>
          ...
          <div className="flex sm:flex-col items-center justify-center px-1 py-1 sm:py-0">
            ...
            <div className="text-3xl" style={{ color: activeG?.color ?? '#f97316' }}>→</div>
          ...
          <div className="flex-1 text-center rounded-xl border-2 p-3.5 transition-all duration-300" style={{ borderColor: activeG?.color ?? '#f97316', background: `${activeG?.color ?? '#f97316'}18` }}>
            ...
            <p className="text-4xl font-black leading-none text-white">{preview.targetKcal.toLocaleString()}</p>
        ...
        {macroRows.map((m, i) => (
          <div key={m.label} className="rounded-xl border p-4" style={{ borderColor: `${m.color}22`, background: `${m.color}05` }}>
            <div className="flex items-start justify-between mb-2.5">
              <div>
                <p className="text-base font-bold text-text">{m.label}</p>
                <p className="text-[9px] text-muted/60 mt-0.5">{m.formula}</p>
              </div>
              <div className="text-right">
                <div className="flex items-baseline gap-0.5 justify-end">
                  <span className="text-3xl font-black leading-none" style={{ color: m.color }}>{m.g}</span>
      ...
      {milestones.length > 0 && (<>
        ...
        <div className="rounded-2xl border p-5" style={{ borderColor: 'rgba(249,115,22,0.2)', background: 'rgba(249,115,22,0.03)' }}>
          <div className="flex items-center justify-between mb-1">
            <p className="text-lg font-bold text-text">{b3tr.milestone_title || 'Tiến độ theo mốc cân nặng'}</p>
          ...
          <div className="grid grid-cols-4 gap-2 text-center">
            {milestones.map(m => (
              <div key={m.kg} className="rounded-lg p-2.5 border" style={{ borderColor: 'rgba(249,115,22,0.15)', background: 'rgba(249,115,22,0.05)' }}>
                <p className="text-xl font-black leading-none" style={{ color: activeG?.color ?? '#f97316' }}>{preview.delta < 0 ? '−' : '+'}{m.kg}kg</p>
      ...
      <div className="relative rounded-3xl overflow-hidden h-40 mt-8 mb-6">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-5">
          ...
          <p className="text-lg font-bold text-white leading-snug max-w-sm italic">
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-2">
        <div className="rounded-2xl border p-4" style={{ borderColor: 'rgba(249,115,22,0.2)', background: 'rgba(249,115,22,0.04)' }}>
          <p className="text-5xl font-black leading-none mb-2" style={{ color: '#f97316' }}>70%</p>
          <p className="text-base font-bold text-text mb-1.5">{b3tr.consistency_title || 'Kiên trì vừa phải đủ thắng'}</p>
        ...
        <div className="rounded-2xl border p-4" style={{ borderColor: 'rgba(34,197,94,0.2)', background: 'rgba(34,197,94,0.04)' }}>
          <p className="text-5xl font-black leading-none mb-2" style={{ color: '#22c55e' }}>80/20</p>
          <p className="text-base font-bold text-text mb-1.5">{b3tr.rule_8020_title || 'Quy tắc linh hoạt bền vững'}</p>
    ...
    <div>
      ...
      <div key={activeGoal} className="rounded-2xl border mb-6 overflow-hidden animate-fade-in-up"
        ...
        <div className="p-4">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-base font-black px-2.5 py-0.5 rounded-full border"
          ...
          <div className="space-y-2">
            {adaptation.tweaks.map((t, i) => (
              <div key={i} className="flex items-start gap-2.5 rounded-xl p-2.5"
                ...
                <span className="text-lg shrink-0 leading-none mt-0.5">{t.icon}</span>
                <div>
      ...
      <div key={activeDay} className="animate-fade-in-up">
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <span className="text-base font-bold text-text">{tPillars(`pillarB.b4.meal_days.${activeDay}.day`, { defaultValue: day.day })}</span>
        ...
        <div className="rounded-2xl border p-4 mb-6 flex items-center gap-4 flex-wrap" style={{ borderColor: `${day.color}30`, background: `${day.color}06` }}>
          <div className="flex items-center gap-2">
            ...
            <span className="text-base font-bold" style={{ color: day.color }}>{b4tr.total_label || 'Tổng ngày'}</span>
          </div>
          {[
        ...
        <div className="rounded-2xl border p-5" style={{ borderColor: `${day.color}22`, background: `${day.color}04` }}>
          <div className="flex items-start justify-between mb-3">
            <p className="text-lg font-bold text-text leading-snug pr-3">{tPillars(`pillarB.b4.meal_days.${activeDay}.analysis_headline`, { defaultValue: day.analysis.headline })}</p>
    ...
    >
      ...
      >
        ...
        <div className="relative h-28 overflow-hidden">
          ...
          {/* Emoji badge */}
          <div
            className="absolute top-2.5 right-2.5 w-8 h-8 rounded-xl flex items-center justify-center text-xl transition-all duration-300"
            style={{
              background: `${c}22`,
        ...
        <div className="p-4 relative z-10">
          <div className="flex items-start justify-between gap-2 mb-1.5">
            <p className="text-base font-bold leading-snug transition-colors duration-200" style={{ color: titleColor }}>
              {section.label}
            </p>
            <span
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border border-lime-500/20 bg-lime-500/4 overflow-hidden">
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <div className="w-7 h-7 rounded-xl bg-lime-500/12 border border-lime-500/30 flex items-center justify-center text-lg">✅</div>
              <span className="text-lg font-bold text-text">{b5tr.checklist_title || 'Checklist Hàng Ngày'}</span>
            </div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-base font-black text-lime-400 bg-lime-500/10 border border-lime-500/25 px-2.5 py-0.5 rounded-full">
          ...
          {allDone && (
            <div className="mt-5 flex items-center gap-3 bg-lime-500/10 border border-lime-500/25 rounded-xl px-4 py-3">
              ...
              <p className="text-lg font-bold text-lime-300">{b5tr.done_msg || 'Hoàn thành! Thói quen nhỏ mỗi ngày tạo nên kết quả lớn.'}</p>
            </div>
          )}
        </div>
      </div>
      ...
      <div className="relative rounded-2xl overflow-hidden h-36">
        ...
        <div className="absolute inset-0 p-5 flex flex-col justify-center">
          ...
          <p className="text-lg font-black text-text leading-snug max-w-xs">"{tPillars('pillarB.b5.philosophy_motto', { defaultValue: 'Ăn tốt hơn hôm qua một chút, đủ dễ để ngày mai còn làm tiếp.' })}"</p>
          ...
          {DAILY_SCIENCE.map((item, i) => (
            <div key={i} className="rounded-2xl border p-4 hover:scale-[1.01] transition-all duration-200"
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-base font-bold leading-snug" style={{ color: item.color }}>{tPillars(`pillarB.b5.science_cards.${i}.title`, { defaultValue: item.title })}</p>
              </div>
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-1">
        ...
        <p className="text-base font-bold text-text">Thành Phần Cơ Thể — So Sánh 3 Kịch Bản</p>
      </div>
    ...
    <div className="space-y-4">
            ...
            {TRACKING_WEEKLY_RICH.map((item, i) => (
              <div key={i} className="flex items-start gap-3 p-3.5 rounded-xl border transition-all duration-200 hover:scale-[1.02] cursor-default"
                ...
                <div className="min-w-0">
                  <p className="text-base font-bold leading-snug" style={{ color: item.color }}>{item.label}</p>
        ...
        <div className="grid sm:grid-cols-2 gap-2">
          {WEEKLY_PROTOCOL.map((p, i) => (
            <div key={i} className="flex items-start gap-3 p-3.5 rounded-xl border"
              ...
              <div className="w-7 h-7 rounded-xl flex items-center justify-center text-base font-black shrink-0"
          ...
          {thresholds.map((t, i) => (
            <div key={i} className="rounded-2xl border" style={{ borderColor: `${t.color}18`, background: `${t.color}03` }}>
              ...
              <div className="px-4 pt-4 pb-3 flex items-start gap-3" style={{ borderBottom: `1px solid ${t.color}12` }}>
                ...
                <div>
                  <p className="text-base font-black mb-0.5" style={{ color: t.color }}>{t.metric}</p>
      ...
      <div className="rounded-2xl border border-yellow-500/20 bg-yellow-500/4 p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <p className="text-base font-bold text-yellow-300">Test 4 Tuần — Đánh Giá Tiến Bộ Thực Sự</p>
        </div>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border border-orange-500/20 bg-orange-500/4 overflow-hidden">
        ...
        <div className="p-6">
          <div className="flex items-center gap-2 mb-5">
            <div className="w-7 h-7 rounded-xl bg-orange-500/12 border border-orange-500/30 flex items-center justify-center text-lg">⚡</div>
            <div>
              <span className="text-lg font-bold text-text">Điều Chỉnh & Tối Ưu</span>
      ...
      <div className="relative rounded-2xl overflow-hidden h-36">
        ...
        <div className="absolute inset-0 p-5 flex flex-col justify-center">
          ...
          <p className="text-lg font-black text-text leading-snug max-w-xs">Thay đổi 1 biến, đợi 2 tuần, đo lại — không thay đổi nhiều thứ cùng lúc.</p>
      ...
      <div className="rounded-2xl border border-lime-500/15 bg-lime-500/3 p-4">
        <div className="flex items-center gap-2 mb-3">
          <span className="text-xl">🏅</span>
          <p className="text-base font-bold text-lime-300">Tiến Bộ Không Cần Cân Số</p>
  ...
  return (
    <div className="space-y-5">
      ...
      <RevealBlock delay={60}>
        <div className="mt-4">
          <div className="flex items-center gap-3 mb-5">
            <div className="w-9 h-9 rounded-xl bg-purple-500/12 border border-purple-500/20 flex items-center justify-center text-3xl shrink-0">🌱</div>
            <div>
              <p className="text-lg font-bold text-text">{b5tr.habits_title || 'Thói Quen Ăn Uống Bền Vững'}</p>
                ...
                <RevealBlock key={i} delay={i * 60}>
                  <div className="rounded-2xl border p-5 h-full" style={{ borderColor: `${h.color}22`, background: `${h.color}05` }}>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <p className="text-base font-bold" style={{ color: h.color }}>{tPillars(`pillarB.b5.habits.${i}.title`, { defaultValue: h.title })}</p>
                    </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4 mt-2">
          ...
          <div className="rounded-2xl border border-red-500/20 bg-red-500/5 p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                <p className="text-lg font-bold text-red-300">{b5tr.no3_title || 'Quy Tắc 3 Không'}</p>
          ...
          <div className="rounded-2xl border border-green-500/20 bg-green-500/5 p-5">
            <div className="flex items-center gap-2 mb-4">
              <span className="text-4xl">✅</span>
              <div>
                <p className="text-lg font-bold text-green-300">{b5tr.reset_title || 'Quy Tắc Quay Lại'}</p>
  ...
  const numInput = (val, set, min, max) => (
    <div className="flex items-center gap-1">
      <button
        ...
        className="w-7 h-7 rounded-lg border border-border/50 bg-white/[0.04] text-muted hover:text-text hover:border-violet-500/40 transition-all duration-150 flex items-center justify-center text-lg font-bold cursor-pointer"
      >−</button>
      <input
        type="number"
        min={min}
        ...
        className="w-16 text-center bg-white/[0.04] border border-border/50 rounded-lg py-1 text-lg font-bold text-text focus:outline-none focus:border-violet-500/60"
      />
      <button
        type="button"
    ...
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-violet-500/20 bg-violet-500/5 p-5">
        <div className="flex items-start gap-4">
          <div className="w-9 h-9 rounded-xl bg-violet-500/15 border border-violet-500/30 flex items-center justify-center text-2xl shrink-0">🔬</div>
          <div>
            <p className="text-lg font-bold text-violet-300 mb-1.5">{b0tr.what || 'TDEE là gì?'}</p>
              ...
              {[
                ...
                <div key={c.label} className="group/tdeec relative">
                  ...
                  <div className="rounded-xl p-3 text-center cursor-help transition-all duration-200 hover:scale-[1.04]" style={{ background: `${c.color}0c`, border: `1px solid ${c.color}25` }}>
                    ...
                    <p className="text-base font-black mt-1" style={{ color: c.color }}>{c.label}</p>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center justify-between">
            <span className="text-base text-muted">{b0tr.weight_label || 'Cân nặng (kg)'}</span>
            {numInput(weight, setWeight, 30, 200)}
          </div>
          {/* Height */}
          <div className="flex items-center justify-between">
            <span className="text-base text-muted">{b0tr.height_label || 'Chiều cao (cm)'}</span>
            {numInput(height, setHeight, 100, 250)}
          </div>
          {/* Age */}
          <div className="flex items-center justify-between">
            <span className="text-base text-muted">{b0tr.age_label || 'Tuổi'}</span>
            {numInput(age, setAge, 10, 100)}
          </div>

          {/* Sex toggle */}
          <div className="flex items-center justify-between">
            <span className="text-base text-muted">{b0tr.sex_label || 'Giới tính'}</span>
            <div className="flex gap-2">
              {['male', 'female'].map(s => (
                <button
                  key={s}
                  type="button"
                  onClick={() => setSex(s)}
                  className={`px-3 py-1 rounded-lg text-base font-bold border transition-all duration-200 cursor-pointer ${
                    sex === s
          ...
          {/* Activity */}
          <div>
            <p className="text-base text-muted mb-2">{b0tr.activity_label || 'Mức hoạt động'}</p>
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-violet-500/25 bg-violet-500/8 p-5 text-center">
            ...
            <p className="text-6xl font-black" style={{ color: '#8b5cf6' }}>{tdee.toLocaleString()}</p>
            <p className="text-base text-muted mt-1">{b0tr.kcal_per_day || 'kcal / ngày'}</p>
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-base font-black text-text">{kcal.toLocaleString()} kcal</span>
                  </div>
                  {isActive && (
          ...
          {[
            ...
            <div key={item.label} className="group/calcstat relative">
              ...
              <div className="rounded-2xl border p-4 text-center transition-all duration-200 hover:scale-[1.03] cursor-help" style={{ borderColor: `${item.color}25`, background: `${item.color}07` }}>
                ...
                <p className="text-lg font-black mt-1.5 mb-0.5" style={{ color: item.color }}>{item.value}</p>
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {[
            ...
            <div key={b.icon} className="flex items-start gap-3 p-4 rounded-2xl border transition-all duration-200 hover:scale-[1.01] hover:-translate-y-0.5" style={{ borderColor: `${b.color}20`, background: `${b.color}06` }}>
              ...
              <div>
                <p className="text-base font-bold mb-1" style={{ color: b.color }}>{btr.title || b.title}</p>
      ...
      <RevealBlock delay={100}>
        <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-4 flex items-start gap-3">
          ...
          <div>
            <p className="text-base font-bold text-amber-300 mb-1.5">{b0tr.accuracy_label || 'Độ chính xác & Lưu ý'}</p>
            <p className="text-[11px] text-muted leading-relaxed">
          ...
          {MEAL_SPLIT_RULES.map((r, i) => (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-base font-bold text-text">{b0tr.meal_split_rules?.[i]?.title || r.title}</p>
              </div>
    ...
    <div className="grid grid-cols-3 gap-2">
      <div className="rounded-xl border border-border/30 bg-surface/5 p-3">
        ...
        <p className="text-3xl font-black text-text leading-none">
          {(s.tdee / 1000).toFixed(1)}<span className="text-base font-normal text-muted">k</span>
        </p>
      ...
      <div className="rounded-xl border border-pink-500/30 bg-pink-500/5 p-3">
        ...
        <p className="text-3xl font-black text-pink-300 leading-none">
          {(s.trainingDayKcal / 1000).toFixed(1)}<span className="text-base font-normal text-pink-400">k</span>
        </p>
      ...
      <div className="rounded-xl border border-cyan-500/30 bg-cyan-500/5 p-3">
        ...
        <p className="text-3xl font-black text-cyan-300 leading-none">
          {(s.restDayKcal / 1000).toFixed(1)}<span className="text-base font-normal text-cyan-400">k</span>
        </p>
  ...
  return (
    <div className="space-y-8">
      ...
      <RevealBlock delay={40}>
        <div className="rounded-2xl overflow-hidden h-40 relative border border-pink-500/15">
          ...
          <div className="absolute inset-0 flex flex-col justify-center p-5">
            <p className="text-lg font-bold text-pink-300 mb-1">{b6tr.meal_prep_headline || 'Meal Prep = Thành Công 70%'}</p>
          ...
          {SEVEN_DAY_PLAN.map((d, i) => {
            ...
            return (
              <button
                ...
                type="button"
                onClick={() => setActiveDay(i)}
                className={`px-3 py-2 rounded-xl text-base font-bold border transition-all duration-200 whitespace-nowrap cursor-pointer ${
                  activeDay === i
            ...
            {[
              ...
              return (
                <div key={fi} className="rounded-xl border p-3.5 flex gap-3" style={{ borderColor: `${color}20`, background: `${color}06` }}>
                  <span className="text-4xl shrink-0 leading-none mt-0.5">{icon}</span>
                  <div>
                    <p className="text-base font-bold text-text/80 mb-1">{ffLabel}</p>
      ...
      <RevealBlock delay={80}>
        ...
        >
          <div className="flex items-center gap-2">
            <span className="text-lg font-bold text-pink-300">{b6tr.shopping_title || 'Danh Sách Mua Sắm Tuần'}</span>
            <span className="text-[10px] text-muted border border-border/30 rounded-full px-2 py-0.5">~490.000₫/tuần</span>
          </div>
          <span className="text-muted text-2xl transition-transform duration-200" style={{ transform: showShopping ? 'rotate(180deg)' : 'rotate(0deg)' }}>▾</span>
        </button>
        {showShopping && (
          <div className="mt-3 grid sm:grid-cols-2 gap-3 animate-fade-in-up">
            {SHOPPING_GROUPS.map((g, gi) => (
              <div key={g.name} className="rounded-2xl border p-4" style={{ borderColor: `${g.color}25`, background: `${g.color}06` }}>
                <div className="flex items-center justify-between mb-3">
                  <p className="text-base font-bold" style={{ color: g.color }}>{b6tr.shopping_groups?.[gi] || g.name}</p>
      ...
      <div className="grid grid-cols-3 gap-2">
        {steps.map((step, i) => (
          <div key={step.label} className="rounded-xl border p-3 text-center relative" style={{ borderColor: `${step.color}30`, background: `${step.color}08` }}>
            {i < steps.length - 1 && (
              <span className="absolute -right-1.5 top-1/2 -translate-y-1/2 text-muted/30 text-base z-10 hidden sm:block">→</span>
            )}
            <p className="text-[9px] font-bold text-muted uppercase tracking-widest mb-1.5">{step.label}</p>
            <p className="text-3xl font-black leading-none mb-1" style={{ color: step.color }}>{step.value}</p>
    ...
    <div className="grid sm:grid-cols-2 gap-4">
      <div className="rounded-2xl border border-orange-500/25 bg-orange-500/5 p-5">
        <div className="flex items-center gap-2 mb-4">
          <span className="text-4xl">⚡</span>
          <div>
            <p className="text-lg font-bold text-orange-300">Pre-Workout</p>
      ...
      <div className="rounded-2xl border border-green-500/25 bg-green-500/5 p-5">
        <div className="flex items-center gap-2 mb-4">
          <span className="text-4xl">💪</span>
          <div>
            <p className="text-lg font-bold text-green-300">Post-Workout</p>
        ...
        <RevealBlock key={i} delay={i * 60}>
          <div className="rounded-2xl border p-4 h-full" style={{ borderColor: `${z.color}25`, background: `${z.color}06` }}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-base font-black" style={{ color: z.color }}>{z.duration}</span>
            </div>
        ...
        <div className="pb-orbit-ring rounded-3xl p-[1.5px]">
          <div className="relative rounded-3xl overflow-hidden h-52 md:h-64">
            ...
            <div className="absolute bottom-4 left-6 flex items-center gap-3">
              <span className="text-amber-400 text-base font-bold uppercase tracking-widest bg-bg/60 px-3 py-1 rounded-full border border-amber-500/20">
      ...
      <RevealBlock>
        <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-6">
          <div className="flex items-center gap-3 mb-5">
            <span className="text-4xl">🧮</span>
            <div>
              <p className="text-lg font-bold text-amber-300">{b7tr.chain_title || 'Chuỗi Tính Toán Macro'}</p>
        ...
        <div className="rounded-2xl border border-border/25 bg-surface/5 p-5">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              <span className="text-4xl">📊</span>
              <div>
                <p className="text-lg font-bold text-text">{b7tr.chart_title || 'Biểu Đồ Chu Kỳ Calo Theo Ngày'}</p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mt-2">
            {[
              ...
              <div key={d.label} className="rounded-xl p-3 text-center" style={{ background: `${d.color}08`, border: `1px solid ${d.color}20` }}>
                ...
                <p className="text-xl font-black leading-none mb-1" style={{ color: d.color }}>{(d.kcal / 1000).toFixed(1)}k</p>
      ...
      <RevealBlock delay={60}>
        <div className="space-y-3">
          <div className="flex items-center gap-3 mb-1">
            <span className="text-4xl">⚡</span>
            <div>
              <p className="text-lg font-bold text-text">{b7tr.peri_title || 'Giao Thức Dinh Dưỡng Quanh Buổi Tập'}</p>
      ...
      <RevealBlock delay={80}>
        <div className="space-y-3">
          <div className="flex items-center gap-3 mb-1">
            <span className="text-4xl">🏁</span>
            <div>
              <p className="text-lg font-bold text-text">{b7tr.endurance_title || 'Hướng Dẫn Nạp Nhiên Liệu Sức Bền'}</p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {TRAINING_DAY_TYPES.map((d, dIdx) => (
            <RevealBlock key={d.type}>
              ...
              >
                <div className="flex items-center gap-2 mb-3">
                  <span className="text-lg font-black" style={{ color: d.color }}>{tPillars(`pillarB.b7.training_day_types.${dIdx}.type`, { defaultValue: d.type })}</span>
                  <span
        ...
        <div className="rounded-2xl border border-border/30 bg-surface/10 overflow-hidden">
          {TIMING_SCHEDULE.map((t, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-base font-bold text-text mb-0.5">{tPillars(`pillarB.b7.timing_schedule.${i}.label`, { defaultValue: t.label })}</p>
          ...
          {ATHLETE_PRINCIPLES.map((p, i) => (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-base font-bold text-amber-300">{tPillars(`pillarB.b7.athlete_principles.${i}.title`, { defaultValue: p.title })}</p>
              </div>
  ...
  return (
    <RevealBlock className="mb-16">
      ...
      <div className="pb-orbit-ring rounded-3xl p-[1.5px] mb-8">
        <div className="relative rounded-3xl overflow-hidden h-44 md:h-56">
          ...
          <div className="absolute inset-y-0 left-0 px-8 flex flex-col justify-center max-w-md">
            ...
            <h3 className="text-3xl font-black text-text leading-tight mb-2">
      ...
      <div className="rounded-2xl border border-border/25 bg-surface/5 p-5 mb-6">
        <div className="flex items-center justify-between mb-3">
          <div>
            <p className="text-base font-bold text-text">Biểu Đồ Tuân Thủ Kế Hoạch Theo Tuần</p>
      ...
      <div className="rounded-2xl border border-border/25 bg-surface/5 p-5 mb-8">
        <div className="flex items-center justify-between mb-3">
          <div>
            <p className="text-base font-bold text-text">Calo Mục Tiêu Theo Từng Giai Đoạn</p>
        ...
        <div className="rounded-2xl border p-5 space-y-4" style={{ borderColor: `${current.color}25`, background: `${current.color}06` }}>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-text mt-0.5">{current.label}</p>
            </div>
          </div>
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-4 md:grid-cols-6 gap-2 relative z-10">
            {(showAll ? [
              ...
              <RevealBlock key={m.w}>
                <div className="text-center">
                  <div className="w-7 h-7 rounded-full border-2 flex items-center justify-center text-lg mx-auto mb-2"
  ...
  if (!pillar || typeof pillar !== 'object') {
    return (
      <div className="flex items-center justify-center py-20">
        <span className="text-muted text-lg">{tCommon('loading')}</span>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-5xl mx-auto -mt-4">
      ...
      <div className="mb-10">
        <Link
          to="/pillars"
          className="inline-flex items-center gap-2 text-muted hover:text-lime-400 text-lg transition-colors duration-200 group"
        >
      ...
      <div className="mb-10 relative">
        ...
        <div className="relative flex items-start gap-6">
          ...
          <div>
            <h1 className="text-6xl md:text-6xl font-bold leading-tight animate-fade-in-up">
              {(() => {
            ...
            <span className="inline-block text-base font-bold uppercase tracking-widest text-lime-400 mt-3 mb-4 px-3 py-1 bg-lime-500/10 border border-lime-500/20 rounded-full">
      ...
      <div className="pb-orbit-ring rounded-3xl p-[1.5px] mb-12">
        <div className="relative rounded-3xl overflow-hidden h-52 md:h-72">
          ...
          <div className="absolute bottom-4 left-6">
            <span className="text-lime-400 text-base font-bold uppercase tracking-widest bg-bg/60 px-3 py-1 rounded-full border border-lime-500/20">
      ...
      <RevealBlock className="mb-16">
        ...
        <div className="relative rounded-3xl border border-lime-500/15 bg-lime-500/4 p-7 md:p-10 mb-10 group hover:border-lime-500/30 transition-all duration-500">
          ...
          <div className="relative z-10 max-w-2xl mx-auto mb-7 text-center">
            <p className="text-3xl md:text-4xl font-bold text-text/90 leading-relaxed italic mb-4">
            ...
            <p className="text-lg text-lime-400/80 font-medium">
          ...
          <div className="relative z-10 grid grid-cols-2 md:grid-cols-4 gap-3">
            {HERO_STATS_DEFAULT.map((s, i) => (
              ...
              >
                ...
                <div className="font-black text-3xl leading-none mb-0.5" style={{ color: LIME }}>
                  {s.n}<span className="text-base font-bold opacity-60 ml-0.5">{tPillars(`pillarB.hero_stats.${i}.unit`, { defaultValue: s.unit })}</span>
                </div>
        ...
        <div className="flex flex-col items-center gap-3 mb-8">
          ...
          <div className="flex items-end gap-4 select-none">
            ...
            <div className="pb-3">
              ...
              <p className="text-4xl font-black text-text uppercase tracking-[0.1em] leading-none">{pillar?.principles_title || 'Cốt Lõi'}</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="p-5 flex flex-col flex-1">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-3xl w-9 h-9 flex items-center justify-center rounded-xl border bg-lime-500/10 border-lime-500/25">✨</span>
              </div>
              <p className="text-base font-bold text-lime-300 leading-relaxed mb-3">
          ...
          <div className="flex flex-col items-center gap-3 mb-8">
            ...
            <div className="flex items-end gap-4 select-none">
              ...
              <div className="pb-3">
                ...
                <p className="text-4xl font-black text-text uppercase tracking-[0.1em] leading-none">{pillar?.tabs_section_title || 'Dinh Dưỡng'}</p>
              </div>
            </div>
                  ...
                  {TABS.map((t, i) => {
                    ...
                    return (
                      <button
                        ...
                        type="button"
                        onClick={() => switchTab(i)}
                        className="group relative flex items-center gap-2 px-4 py-3 text-base font-bold transition-all duration-250 focus:outline-none cursor-pointer whitespace-nowrap"
                        style={{
          ...
          {TIERS.map((tier, i) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <h3 className={`text-xl font-black mb-4 ${tier.text}`}>{pillar?.tiers?.[i]?.level || tier.level}</h3>
        ...
        <div className="relative rounded-2xl border border-lime-500/20 bg-lime-500/4 p-6 overflow-hidden">
          ...
          <div className="relative flex flex-col md:flex-row md:items-center gap-5">
            <div className="flex items-center gap-3 shrink-0">
              ...
              <p className="text-lg font-bold text-lime-400">{pillar?.safety_label || 'An toàn trước'}</p>
            </div>
            <div className="flex-1">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          >
            ...
            <div className="relative">
              ...
              <h3 className="font-black text-text text-xl mb-1">{pillar?.cta_program_title || 'Lộ Trình 12 Tuần'}</h3>
              <p className="text-muted text-base leading-relaxed mb-4">{pillar?.cta_program_desc || 'Kết hợp dinh dưỡng + vận động theo kế hoạch có cấu trúc rõ ràng từng giai đoạn.'}</p>
              <span className="inline-flex items-center gap-1.5 text-lime-400 text-base font-bold group-hover:gap-2.5 transition-all">
          ...
          >
            ...
            <div className="relative">
              ...
              <h3 className="font-black text-text text-xl mb-1">{pillar?.cta_pillars_title || '6 Trụ Cột Sức Khỏe'}</h3>
              <p className="text-muted text-base leading-relaxed mb-4">{pillar?.cta_pillars_desc || 'Dinh dưỡng chỉ là 1 trong 6 trụ cột. Khám phá vận động, phục hồi, giấc ngủ và cả tinh thần.'}</p>
              <span className="inline-flex items-center gap-1.5 text-teal-400 text-base font-bold group-hover:gap-2.5 transition-all">
