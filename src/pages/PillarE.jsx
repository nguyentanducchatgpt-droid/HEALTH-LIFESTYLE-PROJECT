...
export default function PillarE() {
  ...
  const healthMetrics    = tPillars('pillarE.health_metrics',    { returnObjects: true }) || [];
  const warningSigns     = tPillars('pillarE.warning_signs',     { returnObjects: true }) || [];
  const preventionHabits = tPillars('pillarE.prevention_habits', { returnObjects: true }) || [];
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-12">
        <h2 className="text-xl font-bold text-text mb-6 flex items-center gap-2">
          ...
          {tPillars('pillarE.metrics_title')}
        </h2>
        ...
        <div className="flex items-start gap-3 mb-5">
          ...
          <div>
            <h2 className="font-bold text-red-400 text-lg leading-snug">
              {tPillars('pillarE.warning_title')}
            </h2>
            <p className="text-red-400/60 text-xs mt-0.5">
              {tPillars('pillarE.warning_subtitle')}
            </p>
          </div>
        </div>
      ...
      <div className="mb-12">
        <div className="bg-surface border border-blue-500/20 rounded-2xl p-6">
          <h2 className="text-lg font-bold text-text mb-1 flex items-center gap-2">
            <span>✅</span> {tPillars('pillarE.prevention_title')}
          </h2>
          <p className="text-muted text-xs mb-5">
            {tPillars('pillarE.prevention_subtitle')}
          </p>
          <ul className="space-y-3">
            {preventionHabits.map((habit, i) => (
