  ...
  return (
    <div className="px-4 md:px-6 max-w-4xl mx-auto pt-28 md:pt-32 pb-24">
      ...
      <RevealBlock delay={0} className="mb-12">
        ...
        <p className="text-muted text-lg mb-6">Nhấn vào từng giai đoạn để xem mục tiêu và công cụ cần dùng.</p>
            ...
            <div key={i} className="rounded-2xl border border-border bg-surface overflow-hidden">
              <button onClick={() => setOpenPhase(openPhase === i ? null : i)} className="w-full p-4 text-left hover:bg-white/5 transition-colors">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl flex items-center justify-center font-black text-lg" style={{ background: `${ph.color}20`, color: ph.color }}>P{ph.phase}</div>
